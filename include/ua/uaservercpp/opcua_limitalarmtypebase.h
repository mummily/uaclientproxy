 ...
 *  ------------------|----------|----------------|----------------|-----------------------------------------------------
 *  BaseHighHighLimit | Double   | PropertyType   | Optional       | \ref getBaseHighHighLimit, \ref setBaseHighHighLimit
 *  BaseHighLimit     | Double   | PropertyType   | Optional       | \ref getBaseHighLimit, \ref setBaseHighLimit
 *  BaseLowLimit      | Double   | PropertyType   | Optional       | \ref getBaseLowLimit, \ref setBaseLowLimit
 *  BaseLowLowLimit   | Double   | PropertyType   | Optional       | \ref getBaseLowLowLimit, \ref setBaseLowLowLimit
...
public:
    ...
    // BaseHighHighLimit
    void setBaseHighHighLimit(OpcUa_Double BaseHighHighLimit);
    void setBaseHighHighLimitStatus(OpcUa_StatusCode status);
    OpcUa_Double getBaseHighHighLimit();
    virtual void getBaseHighHighLimitValue(Session* pSession, OpcUa_Variant& value);
    // BaseHighLimit
    void setBaseHighLimit(OpcUa_Double BaseHighLimit);
    void setBaseHighLimitStatus(OpcUa_StatusCode status);
    OpcUa_Double getBaseHighLimit();
    virtual void getBaseHighLimitValue(Session* pSession, OpcUa_Variant& value);
    // BaseLowLimit
    void setBaseLowLimit(OpcUa_Double BaseLowLimit);
    void setBaseLowLimitStatus(OpcUa_StatusCode status);
    OpcUa_Double getBaseLowLimit();
    virtual void getBaseLowLimitValue(Session* pSession, OpcUa_Variant& value);
    // BaseLowLowLimit
    void setBaseLowLowLimit(OpcUa_Double BaseLowLowLimit);
    void setBaseLowLowLimitStatus(OpcUa_StatusCode status);
    OpcUa_Double getBaseLowLowLimit();
    virtual void getBaseLowLowLimitValue(Session* pSession, OpcUa_Variant& value);
    // HighHighLimit
...
public:
    ...
    virtual OpcUa::PropertyType* getBaseHighHighLimitNode();
    virtual const OpcUa::PropertyType* getBaseHighHighLimitNode() const;
    virtual OpcUa::PropertyType* getBaseHighLimitNode();
    virtual const OpcUa::PropertyType* getBaseHighLimitNode() const;
    virtual OpcUa::PropertyType* getBaseLowLimitNode();
    virtual const OpcUa::PropertyType* getBaseLowLimitNode() const;
    virtual OpcUa::PropertyType* getBaseLowLowLimitNode();
    virtual const OpcUa::PropertyType* getBaseLowLowLimitNode() const;
    virtual OpcUa::PropertyType* getHighHighLimitNode();
    virtual const OpcUa::PropertyType* getHighHighLimitNode() const;
    virtual OpcUa::PropertyType* getHighLimitNode();
    virtual const OpcUa::PropertyType* getHighLimitNode() const;
    virtual OpcUa::PropertyType* getLowLimitNode();
    virtual const OpcUa::PropertyType* getLowLimitNode() const;
    virtual OpcUa::PropertyType* getLowLowLimitNode();
    virtual const OpcUa::PropertyType* getLowLowLimitNode() const;
...
protected:
    // Variable nodes
    // Variable BaseHighHighLimit
    static OpcUa::PropertyType*  s_pBaseHighHighLimit;
    OpcUa::PropertyType*  m_pBaseHighHighLimit;
    // Variable BaseHighLimit
    static OpcUa::PropertyType*  s_pBaseHighLimit;
    OpcUa::PropertyType*  m_pBaseHighLimit;
    // Variable BaseLowLimit
    static OpcUa::PropertyType*  s_pBaseLowLimit;
    OpcUa::PropertyType*  m_pBaseLowLimit;
    // Variable BaseLowLowLimit
    static OpcUa::PropertyType*  s_pBaseLowLowLimit;
    OpcUa::PropertyType*  m_pBaseLowLowLimit;
