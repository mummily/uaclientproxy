...
public:
    ...
    */
    ...
    virtual UaStatus isReadable(Session* pSession, NodeAccessInfo* pDefaultPermissions) const;
    virtual UaStatus isWritable(Session* pSession, NodeAccessInfo* pDefaultPermissions) const;
    virtual UaStatus isBrowseable(Session* pSession, NodeAccessInfo* pDefaultPermissions) const;
    virtual UaStatus isRolePermissionReadable(Session* pSession, NodeAccessInfo* pDefaultPermissions) const;
    virtual UaStatus isRolePermissionWritable(Session* pSession, NodeAccessInfo* pDefaultPermissions) const;
    virtual UaStatus isHistoryReadable(Session* pSession, NodeAccessInfo* pDefaultPermissions) const;
    virtual UaStatus isHistoryInsertable(Session* pSession, NodeAccessInfo* pDefaultPermissions) const;
    virtual UaStatus isHistoryModifiable(Session* pSession, NodeAccessInfo* pDefaultPermissions) const;
    virtual UaStatus isHistoryDeletable(Session* pSession, NodeAccessInfo* pDefaultPermissions) const;
    virtual UaStatus isEventReadable(Session* pSession, NodeAccessInfo* pDefaultPermissions) const;
    virtual UaStatus isExecutable(Session* pSession, NodeAccessInfo* pDefaultPermissions) const;
    virtual UaStatus isAttributeWritable(Session* pSession, NodeAccessInfo* pDefaultPermissions) const;
    virtual UaStatus isHistorizingWritable(Session* pSession, NodeAccessInfo* pDefaultPermissions) const;
...
public:
    ...
    */
    ...
    {
        DataTypeDefinitionType_None = 0,
        DataTypeDefinitionType_Structure,
        DataTypeDefinitionType_Enum
    };
     ...
     *  @return The type of DataTypeDefinition.
     */
    virtual DataTypeDefinitionType dataTypeDefinitionType() const = 0;

    /** Get the StructureDefinition for the UaDataType.
     */
    virtual UaStructureDefinitionDataType structureDefinition() const = 0;

    /** Get the EnumDefinition for the UaDataType.
     */
    virtual UaEnumDefinitionDataType enumDefinition() const = 0;
