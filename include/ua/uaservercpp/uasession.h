...
public:
    ...
    void afterActivate(const OpcUa_Endpoint_SecurityPolicyConfiguration& secureChannelSecurityConfig);
    ...
    void setSecureChannelMutex(UaMutexRefCounted* pSecureChannelMutex);
