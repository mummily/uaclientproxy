...
public:
     ...
     */
    virtual UaDataType::DataTypeDefinitionType dataTypeDefinitionType() const {return UaDataType::DataTypeDefinitionType_None;}

    /** Get the StructureDefinition for the UaDataType.
     */
    virtual UaStructureDefinitionDataType structureDefinition() const {return UaStructureDefinitionDataType(); }

    /** Get the EnumDefinition for the UaDataType.
     */
    virtual UaEnumDefinitionDataType enumDefinition() const {return UaEnumDefinitionDataType(); }
...
/** @brief Generic implementation class for UaDataType that represents a structure.
 */
class SERVER_CORE_EXPORT UaGenericDataTypeStructure :
    public UaGenericDataType
{
protected:
    /** destruction */
    virtual ~UaGenericDataTypeStructure();
public:
    /** construction */
    UaGenericDataTypeStructure(
        const UaNodeId&              nodeId,
        const UaQualifiedName&       browseName,
        const UaLocalizedText&       displayName,
        const UaLocalizedText&       description,
     ...
     *  @return The type of DataTypeDefinition.
     */
    virtual UaDataType::DataTypeDefinitionType dataTypeDefinitionType() const {return UaDataType::DataTypeDefinitionType_Structure;}

    /** Get the StructureDefinition for the UaDataType.
     */
    virtual UaStructureDefinitionDataType structureDefinition() const;

private:
    UaStructureDefinitionDataType m_structureDefinition;
};

/** @brief Generic implementation class for UaDataType that represents an enumeration.
 */
class SERVER_CORE_EXPORT UaGenericDataTypeEnum :
    public UaGenericDataType
{
protected:
    /** destruction */
...
public:
    ...
    UaGenericDataTypeEnum(
        const UaNodeId&         nodeId,
        const UaQualifiedName&  browseName,
        const UaLocalizedText&  displayName,
        const UaLocalizedText&  description,
        OpcUa_Boolean           isAbstract,
        const UaEnumDefinition& enumDefinition);
    ...
    UaGenericDataTypeEnum(
        ...
        const UaLocalizedText&       description,
        OpcUa_Boolean                isAbstract,
        const UaOptionSetDefinition& optionSet);
     ...
     *  @return The type of DataTypeDefinition.
     */
    virtual UaDataType::DataTypeDefinitionType dataTypeDefinitionType() const {return UaDataType::DataTypeDefinitionType_Enum;}
...
private:
    UaEnumDefinitionDataType m_enumDefinition;
};
