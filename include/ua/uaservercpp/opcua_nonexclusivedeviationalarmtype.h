 ...
 *  -----------------|----------|----------------|----------------|---------------------------------------------------
 *  BaseSetpointNode | NodeId   | PropertyType   | Optional       | \ref getBaseSetpointNode, \ref setBaseSetpointNode
...
public:
    ...
    // BaseSetpointNode
    void setBaseSetpointNode(const UaNodeId& BaseSetpointNode);
    void setBaseSetpointNodeStatus(OpcUa_StatusCode status);
    UaNodeId getBaseSetpointNode();
    virtual void getBaseSetpointNodeValue(Session* pSession, OpcUa_Variant& value);
    // SetpointNode
 ...
 *  Browse Name      | DataType | TypeDefinition | Modelling Rule | See Also
 *  -----------------|----------|----------------|----------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
 *  BaseSetpointNode | NodeId   | PropertyType   | Optional       | \ref NonExclusiveDeviationAlarmType::getBaseSetpointNode "getBaseSetpointNode", \ref NonExclusiveDeviationAlarmType::setBaseSetpointNode "setBaseSetpointNode"
 *  SetpointNode     | NodeId   | PropertyType   | Mandatory      | \ref NonExclusiveDeviationAlarmType::getSetpointNode "getSetpointNode", \ref NonExclusiveDeviationAlarmType::setSetpointNode "setSetpointNode"
 *
 *  A special level Alarm utilized with one or more non-exclusive states.
 *
 *  For example if a set point had a value of 10 and the high deviation Alarm limit
...
public:
    ...
    // BaseSetpointNode
    virtual void setBaseSetpointNode(const UaNodeId& BaseSetpointNode);
    virtual UaNodeId getBaseSetpointNode() const;
    virtual void setBaseSetpointNodeStatus(OpcUa_StatusCode status);
    virtual void getBaseSetpointNodeValue(Session* pSession, UaVariant& value);
    // SetpointNode
    ...
    virtual OpcUa::PropertyType* getBaseSetpointNodeNode();
    virtual const OpcUa::PropertyType* getBaseSetpointNodeNode() const;
    virtual OpcUa::PropertyType* getSetpointNodeNode();
    virtual const OpcUa::PropertyType* getSetpointNodeNode() const;
...
protected:
    // Variable nodes
    // Variable BaseSetpointNode
    static OpcUa::PropertyType*  s_pBaseSetpointNode;
    OpcUa::PropertyType*  m_pBaseSetpointNode;
