...
#ifndef _OPCUA_PKI_H_
#define _OPCUA_PKI_H_ 1
...
/** 
  ...
  @param pCertificateStore     [out] The certificate store object.
*/
typedef OpcUa_StatusCode (OpcUa_PKIProvider_PfnLoadPrivateKey)(
    const OpcUa_Void*           loadHandle,
    OpcUa_P_Crypto_Encoding     keyFormat,
    const OpcUa_ByteString*     credentials,
...
/** 
  ...
  @param pCertificateStore     [out] The certificate store object.
*/
OPCUA_EXPORT OpcUa_StatusCode OpcUa_PKIProvider_LoadPrivateKey(
    struct _OpcUa_PKIProvider*   a_pPKI,
    const OpcUa_Void*            a_pLoadHandle,
    OpcUa_P_Crypto_Encoding      a_eKeyFormat,
    const OpcUa_ByteString*      a_pCredentials,
...
/**
  ...
  @param credentials        [in]  Optional password.
  @param pPrivateKey        [in]  Private key data.
*/
typedef OpcUa_StatusCode (OpcUa_PKIProvider_PfnSavePrivateKey)(
...
/**
  ...
  @param a_eKeyFormat         [in]  The destination format (OpcUa_Crypto_Encoding_*)
  @param a_pCredentials       [in]  Optional password.
  @param a_pPrivateKey        [in]  Private key data.
*/
OPCUA_EXPORT OpcUa_StatusCode OpcUa_PKIProvider_SavePrivateKey(
    struct _OpcUa_PKIProvider*   a_pPKI,
    const OpcUa_Void*            a_pSaveHandle,
    OpcUa_P_Crypto_Encoding      a_eKeyFormat,
    const OpcUa_ByteString*      a_pCredentials,
    const OpcUa_Key*             a_pPrivateKey);
...
typedef struct _OpcUa_PKIProvider
{
    ...
    OpcUa_PKIProvider_PfnLoadPrivateKey* LoadPrivateKey;
    OpcUa_PKIProvider_PfnSavePrivateKey*   SavePrivateKey;
