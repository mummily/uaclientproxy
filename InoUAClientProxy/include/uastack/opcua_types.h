...
#if OPCUA_FORCE_INT32_ENUMS
    ,_OpcUa_IdentityCriteriaType_MaxEnumerationValue = OpcUa_Int32_Max
#endif
}
OpcUa_IdentityCriteriaType;

#define OpcUa_IdentityCriteriaType_Clear(xValue) *(xValue) = OpcUa_IdentityCriteriaType_UserName

#define OpcUa_IdentityCriteriaType_Initialize(xValue) *(xValue) = OpcUa_IdentityCriteriaType_UserName

OPCUA_IMEXPORT extern struct _OpcUa_EnumeratedType OpcUa_IdentityCriteriaType_EnumeratedType;
#endif
...
#if OPCUA_FORCE_INT32_ENUMS
    ,_OpcUa_PubSubState_MaxEnumerationValue = OpcUa_Int32_Max
#endif
}
OpcUa_PubSubState;

#define OpcUa_PubSubState_Clear(xValue) *(xValue) = OpcUa_PubSubState_Disabled

#define OpcUa_PubSubState_Initialize(xValue) *(xValue) = OpcUa_PubSubState_Disabled

OPCUA_IMEXPORT extern struct _OpcUa_EnumeratedType OpcUa_PubSubState_EnumeratedType;
#endif
...
#if OPCUA_FORCE_INT32_ENUMS
    ,_OpcUa_DataSetFieldFlags_MaxEnumerationValue = OpcUa_Int32_Max
#endif
}
OpcUa_DataSetFieldFlags;

#define OpcUa_DataSetFieldFlags_Clear(xValue) *(xValue) = OpcUa_DataSetFieldFlags_None

#define OpcUa_DataSetFieldFlags_Initialize(xValue) *(xValue) = OpcUa_DataSetFieldFlags_None

OPCUA_IMEXPORT extern struct _OpcUa_EnumeratedType OpcUa_DataSetFieldFlags_EnumeratedType;
#endif
...
typedef enum _OpcUa_DataSetFieldContentMask
{
    ...
    OpcUa_DataSetFieldContentMask_RawDataEncoding   = 32
#if OPCUA_FORCE_INT32_ENUMS
    ,_OpcUa_DataSetFieldContentMask_MaxEnumerationValue = OpcUa_Int32_Max
#endif
}
OpcUa_DataSetFieldContentMask;

#define OpcUa_DataSetFieldContentMask_Clear(xValue) *(xValue) = OpcUa_DataSetFieldContentMask_None

#define OpcUa_DataSetFieldContentMask_Initialize(xValue) *(xValue) = OpcUa_DataSetFieldContentMask_None

OPCUA_IMEXPORT extern struct _OpcUa_EnumeratedType OpcUa_DataSetFieldContentMask_EnumeratedType;
#endif
...
typedef enum _OpcUa_OverrideValueHandling
{
    ...
    OpcUa_OverrideValueHandling_LastUseableValue = 1,
    OpcUa_OverrideValueHandling_OverrideValue    = 2
#if OPCUA_FORCE_INT32_ENUMS
    ,_OpcUa_OverrideValueHandling_MaxEnumerationValue = OpcUa_Int32_Max
#endif
}
OpcUa_OverrideValueHandling;

#define OpcUa_OverrideValueHandling_Clear(xValue) *(xValue) = OpcUa_OverrideValueHandling_Disabled

#define OpcUa_OverrideValueHandling_Initialize(xValue) *(xValue) = OpcUa_OverrideValueHandling_Disabled

OPCUA_IMEXPORT extern struct _OpcUa_EnumeratedType OpcUa_OverrideValueHandling_EnumeratedType;
#endif
...
#if OPCUA_FORCE_INT32_ENUMS
    ,_OpcUa_DataSetOrderingType_MaxEnumerationValue = OpcUa_Int32_Max
#endif
}
OpcUa_DataSetOrderingType;

#define OpcUa_DataSetOrderingType_Clear(xValue) *(xValue) = OpcUa_DataSetOrderingType_Undefined

#define OpcUa_DataSetOrderingType_Initialize(xValue) *(xValue) = OpcUa_DataSetOrderingType_Undefined

OPCUA_IMEXPORT extern struct _OpcUa_EnumeratedType OpcUa_DataSetOrderingType_EnumeratedType;
#endif
...
#if OPCUA_FORCE_INT32_ENUMS
    ,_OpcUa_UadpNetworkMessageContentMask_MaxEnumerationValue = OpcUa_Int32_Max
#endif
}
OpcUa_UadpNetworkMessageContentMask;

#define OpcUa_UadpNetworkMessageContentMask_Clear(xValue) *(xValue) = OpcUa_UadpNetworkMessageContentMask_None

#define OpcUa_UadpNetworkMessageContentMask_Initialize(xValue) *(xValue) = OpcUa_UadpNetworkMessageContentMask_None

OPCUA_IMEXPORT extern struct _OpcUa_EnumeratedType OpcUa_UadpNetworkMessageContentMask_EnumeratedType;
#endif
...
#if OPCUA_FORCE_INT32_ENUMS
    ,_OpcUa_UadpDataSetMessageContentMask_MaxEnumerationValue = OpcUa_Int32_Max
#endif
}
OpcUa_UadpDataSetMessageContentMask;

#define OpcUa_UadpDataSetMessageContentMask_Clear(xValue) *(xValue) = OpcUa_UadpDataSetMessageContentMask_None

#define OpcUa_UadpDataSetMessageContentMask_Initialize(xValue) *(xValue) = OpcUa_UadpDataSetMessageContentMask_None

OPCUA_IMEXPORT extern struct _OpcUa_EnumeratedType OpcUa_UadpDataSetMessageContentMask_EnumeratedType;
#endif
...
#if OPCUA_FORCE_INT32_ENUMS
    ,_OpcUa_JsonNetworkMessageContentMask_MaxEnumerationValue = OpcUa_Int32_Max
#endif
}
OpcUa_JsonNetworkMessageContentMask;

#define OpcUa_JsonNetworkMessageContentMask_Clear(xValue) *(xValue) = OpcUa_JsonNetworkMessageContentMask_None

#define OpcUa_JsonNetworkMessageContentMask_Initialize(xValue) *(xValue) = OpcUa_JsonNetworkMessageContentMask_None

OPCUA_IMEXPORT extern struct _OpcUa_EnumeratedType OpcUa_JsonNetworkMessageContentMask_EnumeratedType;
#endif
...
#if OPCUA_FORCE_INT32_ENUMS
    ,_OpcUa_JsonDataSetMessageContentMask_MaxEnumerationValue = OpcUa_Int32_Max
#endif
}
OpcUa_JsonDataSetMessageContentMask;

#define OpcUa_JsonDataSetMessageContentMask_Clear(xValue) *(xValue) = OpcUa_JsonDataSetMessageContentMask_None

#define OpcUa_JsonDataSetMessageContentMask_Initialize(xValue) *(xValue) = OpcUa_JsonDataSetMessageContentMask_None

OPCUA_IMEXPORT extern struct _OpcUa_EnumeratedType OpcUa_JsonDataSetMessageContentMask_EnumeratedType;
#endif
...
#if OPCUA_FORCE_INT32_ENUMS
    ,_OpcUa_BrokerTransportQualityOfService_MaxEnumerationValue = OpcUa_Int32_Max
#endif
}
OpcUa_BrokerTransportQualityOfService;

#define OpcUa_BrokerTransportQualityOfService_Clear(xValue) *(xValue) = OpcUa_BrokerTransportQualityOfService_NotSpecified

#define OpcUa_BrokerTransportQualityOfService_Initialize(xValue) *(xValue) = OpcUa_BrokerTransportQualityOfService_NotSpecified

OPCUA_IMEXPORT extern struct _OpcUa_EnumeratedType OpcUa_BrokerTransportQualityOfService_EnumeratedType;
#endif
...
#if OPCUA_FORCE_INT32_ENUMS
    ,_OpcUa_DiagnosticsLevel_MaxEnumerationValue = OpcUa_Int32_Max
#endif
}
OpcUa_DiagnosticsLevel;

#define OpcUa_DiagnosticsLevel_Clear(xValue) *(xValue) = OpcUa_DiagnosticsLevel_Basic

#define OpcUa_DiagnosticsLevel_Initialize(xValue) *(xValue) = OpcUa_DiagnosticsLevel_Basic

OPCUA_IMEXPORT extern struct _OpcUa_EnumeratedType OpcUa_DiagnosticsLevel_EnumeratedType;
#endif
...
#if OPCUA_FORCE_INT32_ENUMS
    ,_OpcUa_PubSubDiagnosticsCounterClassification_MaxEnumerationValue = OpcUa_Int32_Max
#endif
}
OpcUa_PubSubDiagnosticsCounterClassification;

#define OpcUa_PubSubDiagnosticsCounterClassification_Clear(xValue) *(xValue) = OpcUa_PubSubDiagnosticsCounterClassification_Information

#define OpcUa_PubSubDiagnosticsCounterClassification_Initialize(xValue) *(xValue) = OpcUa_PubSubDiagnosticsCounterClassification_Information

OPCUA_IMEXPORT extern struct _OpcUa_EnumeratedType OpcUa_PubSubDiagnosticsCounterClassification_EnumeratedType;
#endif
...
#define OpcUa_PermissionType_Clear(xValue) *(xValue) = OpcUa_PermissionType_None

#define OpcUa_PermissionType_Initialize(xValue) *(xValue) = OpcUa_PermissionType_None
...
#define OpcUa_AccessLevelType_Clear(xValue) *(xValue) = OpcUa_AccessLevelType_None

#define OpcUa_AccessLevelType_Initialize(xValue) *(xValue) = OpcUa_AccessLevelType_None
...
#define OpcUa_AccessLevelExType_Clear(xValue) *(xValue) = OpcUa_AccessLevelExType_None

#define OpcUa_AccessLevelExType_Initialize(xValue) *(xValue) = OpcUa_AccessLevelExType_None
...
#define OpcUa_EventNotifierType_Clear(xValue) *(xValue) = OpcUa_EventNotifierType_None

#define OpcUa_EventNotifierType_Initialize(xValue) *(xValue) = OpcUa_EventNotifierType_None
...
#define OpcUa_StructureType_Clear(xValue) *(xValue) = OpcUa_StructureType_Structure

#define OpcUa_StructureType_Initialize(xValue) *(xValue) = OpcUa_StructureType_Structure
 ...
 *
 *  The two main modes are Disabled and Reporting. Sampling is only used together
 *  with the SetTriggering Service.
 *
 ...
 *
 *  In this special mode the data is sampled in the server but only delivered to
 *  the client in combination with linked monitored items created with
...
{
    OpcUa_QualifiedName Key;
    OpcUa_Variant       Value;
}
OpcUa_KeyValuePair;

OPCUA_EXPORT OpcUa_Void       OpcUa_KeyValuePair_Initialize(OpcUa_KeyValuePair* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_KeyValuePair_Clear(OpcUa_KeyValuePair* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_KeyValuePair_GetSize(OpcUa_KeyValuePair* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_KeyValuePair_Encode(OpcUa_KeyValuePair* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_KeyValuePair_Decode(OpcUa_KeyValuePair* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_KeyValuePair_Compare(const OpcUa_KeyValuePair* pValue1, const OpcUa_KeyValuePair* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_KeyValuePair_Copy(const OpcUa_KeyValuePair* pSource, OpcUa_KeyValuePair** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_KeyValuePair_CopyTo(const OpcUa_KeyValuePair* pSource, OpcUa_KeyValuePair* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_KeyValuePair_EncodeableType;
#endif
...
OPCUA_EXPORT OpcUa_Void       OpcUa_EndpointType_Initialize(OpcUa_EndpointType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_EndpointType_Clear(OpcUa_EndpointType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_EndpointType_GetSize(OpcUa_EndpointType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_EndpointType_Encode(OpcUa_EndpointType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_EndpointType_Decode(OpcUa_EndpointType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_EndpointType_Compare(const OpcUa_EndpointType* pValue1, const OpcUa_EndpointType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_EndpointType_Copy(const OpcUa_EndpointType* pSource, OpcUa_EndpointType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_EndpointType_CopyTo(const OpcUa_EndpointType* pSource, OpcUa_EndpointType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_EndpointType_EncodeableType;
#endif
...
typedef struct _OpcUa_IdentityMappingRuleType
{
    ...
    OpcUa_String               Criteria;
}
OpcUa_IdentityMappingRuleType;

OPCUA_EXPORT OpcUa_Void       OpcUa_IdentityMappingRuleType_Initialize(OpcUa_IdentityMappingRuleType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_IdentityMappingRuleType_Clear(OpcUa_IdentityMappingRuleType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_IdentityMappingRuleType_GetSize(OpcUa_IdentityMappingRuleType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_IdentityMappingRuleType_Encode(OpcUa_IdentityMappingRuleType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_IdentityMappingRuleType_Decode(OpcUa_IdentityMappingRuleType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_IdentityMappingRuleType_Compare(const OpcUa_IdentityMappingRuleType* pValue1, const OpcUa_IdentityMappingRuleType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_IdentityMappingRuleType_Copy(const OpcUa_IdentityMappingRuleType* pSource, OpcUa_IdentityMappingRuleType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_IdentityMappingRuleType_CopyTo(const OpcUa_IdentityMappingRuleType* pSource, OpcUa_IdentityMappingRuleType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_IdentityMappingRuleType_EncodeableType;
#endif
...
OPCUA_EXPORT OpcUa_Void       OpcUa_DecimalDataType_Initialize(OpcUa_DecimalDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_DecimalDataType_Clear(OpcUa_DecimalDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_DecimalDataType_GetSize(OpcUa_DecimalDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_DecimalDataType_Encode(OpcUa_DecimalDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_DecimalDataType_Decode(OpcUa_DecimalDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_DecimalDataType_Compare(const OpcUa_DecimalDataType* pValue1, const OpcUa_DecimalDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_DecimalDataType_Copy(const OpcUa_DecimalDataType* pSource, OpcUa_DecimalDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_DecimalDataType_CopyTo(const OpcUa_DecimalDataType* pSource, OpcUa_DecimalDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_DecimalDataType_EncodeableType;
#endif
...
#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_DataTypeDescription_Compare(const OpcUa_DataTypeDescription* pValue1, const OpcUa_DataTypeDescription* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_DataTypeDescription_Copy(const OpcUa_DataTypeDescription* pSource, OpcUa_DataTypeDescription** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_DataTypeDescription_CopyTo(const OpcUa_DataTypeDescription* pSource, OpcUa_DataTypeDescription* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */
...
OPCUA_EXPORT OpcUa_Void       OpcUa_SimpleTypeDescription_Initialize(OpcUa_SimpleTypeDescription* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_SimpleTypeDescription_Clear(OpcUa_SimpleTypeDescription* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_SimpleTypeDescription_GetSize(OpcUa_SimpleTypeDescription* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_SimpleTypeDescription_Encode(OpcUa_SimpleTypeDescription* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_SimpleTypeDescription_Decode(OpcUa_SimpleTypeDescription* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_SimpleTypeDescription_Compare(const OpcUa_SimpleTypeDescription* pValue1, const OpcUa_SimpleTypeDescription* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_SimpleTypeDescription_Copy(const OpcUa_SimpleTypeDescription* pSource, OpcUa_SimpleTypeDescription** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_SimpleTypeDescription_CopyTo(const OpcUa_SimpleTypeDescription* pSource, OpcUa_SimpleTypeDescription* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_SimpleTypeDescription_EncodeableType;
#endif
...
typedef struct _OpcUa_FieldMetaData
{
    ...
    OpcUa_UInt16            FieldFlags;     /* Fix for 16 Bit OptionSet */
    OpcUa_Byte              BuiltInType;
    ...
    OpcUa_Guid              DataSetFieldId;
    OpcUa_Int32             NoOfProperties;
    OpcUa_KeyValuePair*     Properties;
}
OpcUa_FieldMetaData;

OPCUA_EXPORT OpcUa_Void       OpcUa_FieldMetaData_Initialize(OpcUa_FieldMetaData* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_FieldMetaData_Clear(OpcUa_FieldMetaData* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_FieldMetaData_GetSize(OpcUa_FieldMetaData* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_FieldMetaData_Encode(OpcUa_FieldMetaData* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_FieldMetaData_Decode(OpcUa_FieldMetaData* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_FieldMetaData_Compare(const OpcUa_FieldMetaData* pValue1, const OpcUa_FieldMetaData* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_FieldMetaData_Copy(const OpcUa_FieldMetaData* pSource, OpcUa_FieldMetaData** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_FieldMetaData_CopyTo(const OpcUa_FieldMetaData* pSource, OpcUa_FieldMetaData* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_FieldMetaData_EncodeableType;
#endif
...
OPCUA_EXPORT OpcUa_Void       OpcUa_ConfigurationVersionDataType_Initialize(OpcUa_ConfigurationVersionDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_ConfigurationVersionDataType_Clear(OpcUa_ConfigurationVersionDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_ConfigurationVersionDataType_GetSize(OpcUa_ConfigurationVersionDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_ConfigurationVersionDataType_Encode(OpcUa_ConfigurationVersionDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_ConfigurationVersionDataType_Decode(OpcUa_ConfigurationVersionDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_ConfigurationVersionDataType_Compare(const OpcUa_ConfigurationVersionDataType* pValue1, const OpcUa_ConfigurationVersionDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_ConfigurationVersionDataType_Copy(const OpcUa_ConfigurationVersionDataType* pSource, OpcUa_ConfigurationVersionDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_ConfigurationVersionDataType_CopyTo(const OpcUa_ConfigurationVersionDataType* pSource, OpcUa_ConfigurationVersionDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_ConfigurationVersionDataType_EncodeableType;
#endif
...
{
    OpcUa_NodeId         PublishedVariable;
    ...
    OpcUa_Variant        SubstituteValue;
    OpcUa_Int32          NoOfMetaDataProperties;
    OpcUa_QualifiedName* MetaDataProperties;
}
OpcUa_PublishedVariableDataType;

OPCUA_EXPORT OpcUa_Void       OpcUa_PublishedVariableDataType_Initialize(OpcUa_PublishedVariableDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_PublishedVariableDataType_Clear(OpcUa_PublishedVariableDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_PublishedVariableDataType_GetSize(OpcUa_PublishedVariableDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_PublishedVariableDataType_Encode(OpcUa_PublishedVariableDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_PublishedVariableDataType_Decode(OpcUa_PublishedVariableDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_PublishedVariableDataType_Compare(const OpcUa_PublishedVariableDataType* pValue1, const OpcUa_PublishedVariableDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_PublishedVariableDataType_Copy(const OpcUa_PublishedVariableDataType* pSource, OpcUa_PublishedVariableDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_PublishedVariableDataType_CopyTo(const OpcUa_PublishedVariableDataType* pSource, OpcUa_PublishedVariableDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_PublishedVariableDataType_EncodeableType;
#endif
...
{
    OpcUa_Int32                      NoOfPublishedData;
    OpcUa_PublishedVariableDataType* PublishedData;
}
OpcUa_PublishedDataItemsDataType;

OPCUA_EXPORT OpcUa_Void       OpcUa_PublishedDataItemsDataType_Initialize(OpcUa_PublishedDataItemsDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_PublishedDataItemsDataType_Clear(OpcUa_PublishedDataItemsDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_PublishedDataItemsDataType_GetSize(OpcUa_PublishedDataItemsDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_PublishedDataItemsDataType_Encode(OpcUa_PublishedDataItemsDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_PublishedDataItemsDataType_Decode(OpcUa_PublishedDataItemsDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_PublishedDataItemsDataType_Compare(const OpcUa_PublishedDataItemsDataType* pValue1, const OpcUa_PublishedDataItemsDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_PublishedDataItemsDataType_Copy(const OpcUa_PublishedDataItemsDataType* pSource, OpcUa_PublishedDataItemsDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_PublishedDataItemsDataType_CopyTo(const OpcUa_PublishedDataItemsDataType* pSource, OpcUa_PublishedDataItemsDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_PublishedDataItemsDataType_EncodeableType;
#endif
...
typedef struct _OpcUa_DataSetWriterDataType
{
    ...
    OpcUa_String                  DataSetName;
    OpcUa_Int32                   NoOfDataSetWriterProperties;
    OpcUa_KeyValuePair*           DataSetWriterProperties;
    OpcUa_ExtensionObject         TransportSettings;
    OpcUa_ExtensionObject         MessageSettings;
}
OpcUa_DataSetWriterDataType;

OPCUA_EXPORT OpcUa_Void       OpcUa_DataSetWriterDataType_Initialize(OpcUa_DataSetWriterDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_DataSetWriterDataType_Clear(OpcUa_DataSetWriterDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_DataSetWriterDataType_GetSize(OpcUa_DataSetWriterDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_DataSetWriterDataType_Encode(OpcUa_DataSetWriterDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_DataSetWriterDataType_Decode(OpcUa_DataSetWriterDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_DataSetWriterDataType_Compare(const OpcUa_DataSetWriterDataType* pValue1, const OpcUa_DataSetWriterDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_DataSetWriterDataType_Copy(const OpcUa_DataSetWriterDataType* pSource, OpcUa_DataSetWriterDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_DataSetWriterDataType_CopyTo(const OpcUa_DataSetWriterDataType* pSource, OpcUa_DataSetWriterDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_DataSetWriterDataType_EncodeableType;
#endif
...
OPCUA_EXPORT OpcUa_Void       OpcUa_NetworkAddressDataType_Initialize(OpcUa_NetworkAddressDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_NetworkAddressDataType_Clear(OpcUa_NetworkAddressDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_NetworkAddressDataType_GetSize(OpcUa_NetworkAddressDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_NetworkAddressDataType_Encode(OpcUa_NetworkAddressDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_NetworkAddressDataType_Decode(OpcUa_NetworkAddressDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_NetworkAddressDataType_Compare(const OpcUa_NetworkAddressDataType* pValue1, const OpcUa_NetworkAddressDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_NetworkAddressDataType_Copy(const OpcUa_NetworkAddressDataType* pSource, OpcUa_NetworkAddressDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_NetworkAddressDataType_CopyTo(const OpcUa_NetworkAddressDataType* pSource, OpcUa_NetworkAddressDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_NetworkAddressDataType_EncodeableType;
#endif
...
OPCUA_EXPORT OpcUa_Void       OpcUa_NetworkAddressUrlDataType_Initialize(OpcUa_NetworkAddressUrlDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_NetworkAddressUrlDataType_Clear(OpcUa_NetworkAddressUrlDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_NetworkAddressUrlDataType_GetSize(OpcUa_NetworkAddressUrlDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_NetworkAddressUrlDataType_Encode(OpcUa_NetworkAddressUrlDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_NetworkAddressUrlDataType_Decode(OpcUa_NetworkAddressUrlDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_NetworkAddressUrlDataType_Compare(const OpcUa_NetworkAddressUrlDataType* pValue1, const OpcUa_NetworkAddressUrlDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_NetworkAddressUrlDataType_Copy(const OpcUa_NetworkAddressUrlDataType* pSource, OpcUa_NetworkAddressUrlDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_NetworkAddressUrlDataType_CopyTo(const OpcUa_NetworkAddressUrlDataType* pSource, OpcUa_NetworkAddressUrlDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_NetworkAddressUrlDataType_EncodeableType;
#endif
...
{
    OpcUa_Guid                  DataSetFieldId;
    OpcUa_String                ReceiverIndexRange;
    OpcUa_NodeId                TargetNodeId;
    OpcUa_UInt32                AttributeId;
    OpcUa_String                WriteIndexRange;
    OpcUa_OverrideValueHandling OverrideValueHandling;
    OpcUa_Variant               OverrideValue;
}
OpcUa_FieldTargetDataType;

OPCUA_EXPORT OpcUa_Void       OpcUa_FieldTargetDataType_Initialize(OpcUa_FieldTargetDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_FieldTargetDataType_Clear(OpcUa_FieldTargetDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_FieldTargetDataType_GetSize(OpcUa_FieldTargetDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_FieldTargetDataType_Encode(OpcUa_FieldTargetDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_FieldTargetDataType_Decode(OpcUa_FieldTargetDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_FieldTargetDataType_Compare(const OpcUa_FieldTargetDataType* pValue1, const OpcUa_FieldTargetDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_FieldTargetDataType_Copy(const OpcUa_FieldTargetDataType* pSource, OpcUa_FieldTargetDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_FieldTargetDataType_CopyTo(const OpcUa_FieldTargetDataType* pSource, OpcUa_FieldTargetDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_FieldTargetDataType_EncodeableType;
#endif
...
typedef struct _OpcUa_UadpWriterGroupMessageDataType
{
    ...
    OpcUa_Int32                         NoOfPublishingOffset;
    OpcUa_Double*                       PublishingOffset;
}
OpcUa_UadpWriterGroupMessageDataType;

OPCUA_EXPORT OpcUa_Void       OpcUa_UadpWriterGroupMessageDataType_Initialize(OpcUa_UadpWriterGroupMessageDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_UadpWriterGroupMessageDataType_Clear(OpcUa_UadpWriterGroupMessageDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_UadpWriterGroupMessageDataType_GetSize(OpcUa_UadpWriterGroupMessageDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_UadpWriterGroupMessageDataType_Encode(OpcUa_UadpWriterGroupMessageDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_UadpWriterGroupMessageDataType_Decode(OpcUa_UadpWriterGroupMessageDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_UadpWriterGroupMessageDataType_Compare(const OpcUa_UadpWriterGroupMessageDataType* pValue1, const OpcUa_UadpWriterGroupMessageDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_UadpWriterGroupMessageDataType_Copy(const OpcUa_UadpWriterGroupMessageDataType* pSource, OpcUa_UadpWriterGroupMessageDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_UadpWriterGroupMessageDataType_CopyTo(const OpcUa_UadpWriterGroupMessageDataType* pSource, OpcUa_UadpWriterGroupMessageDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_UadpWriterGroupMessageDataType_EncodeableType;
#endif
...
OPCUA_EXPORT OpcUa_Void       OpcUa_UadpDataSetWriterMessageDataType_Initialize(OpcUa_UadpDataSetWriterMessageDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_UadpDataSetWriterMessageDataType_Clear(OpcUa_UadpDataSetWriterMessageDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_UadpDataSetWriterMessageDataType_GetSize(OpcUa_UadpDataSetWriterMessageDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_UadpDataSetWriterMessageDataType_Encode(OpcUa_UadpDataSetWriterMessageDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_UadpDataSetWriterMessageDataType_Decode(OpcUa_UadpDataSetWriterMessageDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_UadpDataSetWriterMessageDataType_Compare(const OpcUa_UadpDataSetWriterMessageDataType* pValue1, const OpcUa_UadpDataSetWriterMessageDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_UadpDataSetWriterMessageDataType_Copy(const OpcUa_UadpDataSetWriterMessageDataType* pSource, OpcUa_UadpDataSetWriterMessageDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_UadpDataSetWriterMessageDataType_CopyTo(const OpcUa_UadpDataSetWriterMessageDataType* pSource, OpcUa_UadpDataSetWriterMessageDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_UadpDataSetWriterMessageDataType_EncodeableType;
#endif
...
OPCUA_EXPORT OpcUa_Void       OpcUa_UadpDataSetReaderMessageDataType_Initialize(OpcUa_UadpDataSetReaderMessageDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_UadpDataSetReaderMessageDataType_Clear(OpcUa_UadpDataSetReaderMessageDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_UadpDataSetReaderMessageDataType_GetSize(OpcUa_UadpDataSetReaderMessageDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_UadpDataSetReaderMessageDataType_Encode(OpcUa_UadpDataSetReaderMessageDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_UadpDataSetReaderMessageDataType_Decode(OpcUa_UadpDataSetReaderMessageDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_UadpDataSetReaderMessageDataType_Compare(const OpcUa_UadpDataSetReaderMessageDataType* pValue1, const OpcUa_UadpDataSetReaderMessageDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_UadpDataSetReaderMessageDataType_Copy(const OpcUa_UadpDataSetReaderMessageDataType* pSource, OpcUa_UadpDataSetReaderMessageDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_UadpDataSetReaderMessageDataType_CopyTo(const OpcUa_UadpDataSetReaderMessageDataType* pSource, OpcUa_UadpDataSetReaderMessageDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_UadpDataSetReaderMessageDataType_EncodeableType;
#endif
...
OPCUA_EXPORT OpcUa_Void       OpcUa_JsonWriterGroupMessageDataType_Initialize(OpcUa_JsonWriterGroupMessageDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_JsonWriterGroupMessageDataType_Clear(OpcUa_JsonWriterGroupMessageDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_JsonWriterGroupMessageDataType_GetSize(OpcUa_JsonWriterGroupMessageDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_JsonWriterGroupMessageDataType_Encode(OpcUa_JsonWriterGroupMessageDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_JsonWriterGroupMessageDataType_Decode(OpcUa_JsonWriterGroupMessageDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_JsonWriterGroupMessageDataType_Compare(const OpcUa_JsonWriterGroupMessageDataType* pValue1, const OpcUa_JsonWriterGroupMessageDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_JsonWriterGroupMessageDataType_Copy(const OpcUa_JsonWriterGroupMessageDataType* pSource, OpcUa_JsonWriterGroupMessageDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_JsonWriterGroupMessageDataType_CopyTo(const OpcUa_JsonWriterGroupMessageDataType* pSource, OpcUa_JsonWriterGroupMessageDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_JsonWriterGroupMessageDataType_EncodeableType;
#endif
...
OPCUA_EXPORT OpcUa_Void       OpcUa_JsonDataSetWriterMessageDataType_Initialize(OpcUa_JsonDataSetWriterMessageDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_JsonDataSetWriterMessageDataType_Clear(OpcUa_JsonDataSetWriterMessageDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_JsonDataSetWriterMessageDataType_GetSize(OpcUa_JsonDataSetWriterMessageDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_JsonDataSetWriterMessageDataType_Encode(OpcUa_JsonDataSetWriterMessageDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_JsonDataSetWriterMessageDataType_Decode(OpcUa_JsonDataSetWriterMessageDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_JsonDataSetWriterMessageDataType_Compare(const OpcUa_JsonDataSetWriterMessageDataType* pValue1, const OpcUa_JsonDataSetWriterMessageDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_JsonDataSetWriterMessageDataType_Copy(const OpcUa_JsonDataSetWriterMessageDataType* pSource, OpcUa_JsonDataSetWriterMessageDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_JsonDataSetWriterMessageDataType_CopyTo(const OpcUa_JsonDataSetWriterMessageDataType* pSource, OpcUa_JsonDataSetWriterMessageDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_JsonDataSetWriterMessageDataType_EncodeableType;
#endif
...
OPCUA_EXPORT OpcUa_Void       OpcUa_JsonDataSetReaderMessageDataType_Initialize(OpcUa_JsonDataSetReaderMessageDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_JsonDataSetReaderMessageDataType_Clear(OpcUa_JsonDataSetReaderMessageDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_JsonDataSetReaderMessageDataType_GetSize(OpcUa_JsonDataSetReaderMessageDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_JsonDataSetReaderMessageDataType_Encode(OpcUa_JsonDataSetReaderMessageDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_JsonDataSetReaderMessageDataType_Decode(OpcUa_JsonDataSetReaderMessageDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_JsonDataSetReaderMessageDataType_Compare(const OpcUa_JsonDataSetReaderMessageDataType* pValue1, const OpcUa_JsonDataSetReaderMessageDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_JsonDataSetReaderMessageDataType_Copy(const OpcUa_JsonDataSetReaderMessageDataType* pSource, OpcUa_JsonDataSetReaderMessageDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_JsonDataSetReaderMessageDataType_CopyTo(const OpcUa_JsonDataSetReaderMessageDataType* pSource, OpcUa_JsonDataSetReaderMessageDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_JsonDataSetReaderMessageDataType_EncodeableType;
#endif
...
{
    OpcUa_ExtensionObject DiscoveryAddress;
}
OpcUa_DatagramConnectionTransportDataType;

OPCUA_EXPORT OpcUa_Void       OpcUa_DatagramConnectionTransportDataType_Initialize(OpcUa_DatagramConnectionTransportDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_DatagramConnectionTransportDataType_Clear(OpcUa_DatagramConnectionTransportDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_DatagramConnectionTransportDataType_GetSize(OpcUa_DatagramConnectionTransportDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_DatagramConnectionTransportDataType_Encode(OpcUa_DatagramConnectionTransportDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_DatagramConnectionTransportDataType_Decode(OpcUa_DatagramConnectionTransportDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_DatagramConnectionTransportDataType_Compare(const OpcUa_DatagramConnectionTransportDataType* pValue1, const OpcUa_DatagramConnectionTransportDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_DatagramConnectionTransportDataType_Copy(const OpcUa_DatagramConnectionTransportDataType* pSource, OpcUa_DatagramConnectionTransportDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_DatagramConnectionTransportDataType_CopyTo(const OpcUa_DatagramConnectionTransportDataType* pSource, OpcUa_DatagramConnectionTransportDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_DatagramConnectionTransportDataType_EncodeableType;
#endif
...
OPCUA_EXPORT OpcUa_Void       OpcUa_DatagramWriterGroupTransportDataType_Initialize(OpcUa_DatagramWriterGroupTransportDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_DatagramWriterGroupTransportDataType_Clear(OpcUa_DatagramWriterGroupTransportDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_DatagramWriterGroupTransportDataType_GetSize(OpcUa_DatagramWriterGroupTransportDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_DatagramWriterGroupTransportDataType_Encode(OpcUa_DatagramWriterGroupTransportDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_DatagramWriterGroupTransportDataType_Decode(OpcUa_DatagramWriterGroupTransportDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_DatagramWriterGroupTransportDataType_Compare(const OpcUa_DatagramWriterGroupTransportDataType* pValue1, const OpcUa_DatagramWriterGroupTransportDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_DatagramWriterGroupTransportDataType_Copy(const OpcUa_DatagramWriterGroupTransportDataType* pSource, OpcUa_DatagramWriterGroupTransportDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_DatagramWriterGroupTransportDataType_CopyTo(const OpcUa_DatagramWriterGroupTransportDataType* pSource, OpcUa_DatagramWriterGroupTransportDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_DatagramWriterGroupTransportDataType_EncodeableType;
#endif
...
{
    OpcUa_String ResourceUri;
    OpcUa_String AuthenticationProfileUri;
}
OpcUa_BrokerConnectionTransportDataType;

OPCUA_EXPORT OpcUa_Void       OpcUa_BrokerConnectionTransportDataType_Initialize(OpcUa_BrokerConnectionTransportDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_BrokerConnectionTransportDataType_Clear(OpcUa_BrokerConnectionTransportDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_BrokerConnectionTransportDataType_GetSize(OpcUa_BrokerConnectionTransportDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_BrokerConnectionTransportDataType_Encode(OpcUa_BrokerConnectionTransportDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_BrokerConnectionTransportDataType_Decode(OpcUa_BrokerConnectionTransportDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_BrokerConnectionTransportDataType_Compare(const OpcUa_BrokerConnectionTransportDataType* pValue1, const OpcUa_BrokerConnectionTransportDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_BrokerConnectionTransportDataType_Copy(const OpcUa_BrokerConnectionTransportDataType* pSource, OpcUa_BrokerConnectionTransportDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_BrokerConnectionTransportDataType_CopyTo(const OpcUa_BrokerConnectionTransportDataType* pSource, OpcUa_BrokerConnectionTransportDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_BrokerConnectionTransportDataType_EncodeableType;
#endif
...
OPCUA_EXPORT OpcUa_Void       OpcUa_BrokerWriterGroupTransportDataType_Initialize(OpcUa_BrokerWriterGroupTransportDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_BrokerWriterGroupTransportDataType_Clear(OpcUa_BrokerWriterGroupTransportDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_BrokerWriterGroupTransportDataType_GetSize(OpcUa_BrokerWriterGroupTransportDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_BrokerWriterGroupTransportDataType_Encode(OpcUa_BrokerWriterGroupTransportDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_BrokerWriterGroupTransportDataType_Decode(OpcUa_BrokerWriterGroupTransportDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_BrokerWriterGroupTransportDataType_Compare(const OpcUa_BrokerWriterGroupTransportDataType* pValue1, const OpcUa_BrokerWriterGroupTransportDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_BrokerWriterGroupTransportDataType_Copy(const OpcUa_BrokerWriterGroupTransportDataType* pSource, OpcUa_BrokerWriterGroupTransportDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_BrokerWriterGroupTransportDataType_CopyTo(const OpcUa_BrokerWriterGroupTransportDataType* pSource, OpcUa_BrokerWriterGroupTransportDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_BrokerWriterGroupTransportDataType_EncodeableType;
#endif
...
typedef struct _OpcUa_BrokerDataSetWriterTransportDataType
{
    ...
    OpcUa_String                          AuthenticationProfileUri;
    OpcUa_BrokerTransportQualityOfService RequestedDeliveryGuarantee;
    OpcUa_String                          MetaDataQueueName;
    OpcUa_Double                          MetaDataUpdateTime;
}
OpcUa_BrokerDataSetWriterTransportDataType;

OPCUA_EXPORT OpcUa_Void       OpcUa_BrokerDataSetWriterTransportDataType_Initialize(OpcUa_BrokerDataSetWriterTransportDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_BrokerDataSetWriterTransportDataType_Clear(OpcUa_BrokerDataSetWriterTransportDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_BrokerDataSetWriterTransportDataType_GetSize(OpcUa_BrokerDataSetWriterTransportDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_BrokerDataSetWriterTransportDataType_Encode(OpcUa_BrokerDataSetWriterTransportDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_BrokerDataSetWriterTransportDataType_Decode(OpcUa_BrokerDataSetWriterTransportDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_BrokerDataSetWriterTransportDataType_Compare(const OpcUa_BrokerDataSetWriterTransportDataType* pValue1, const OpcUa_BrokerDataSetWriterTransportDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_BrokerDataSetWriterTransportDataType_Copy(const OpcUa_BrokerDataSetWriterTransportDataType* pSource, OpcUa_BrokerDataSetWriterTransportDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_BrokerDataSetWriterTransportDataType_CopyTo(const OpcUa_BrokerDataSetWriterTransportDataType* pSource, OpcUa_BrokerDataSetWriterTransportDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_BrokerDataSetWriterTransportDataType_EncodeableType;
#endif
...
OPCUA_EXPORT OpcUa_Void       OpcUa_BrokerDataSetReaderTransportDataType_Initialize(OpcUa_BrokerDataSetReaderTransportDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_BrokerDataSetReaderTransportDataType_Clear(OpcUa_BrokerDataSetReaderTransportDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_BrokerDataSetReaderTransportDataType_GetSize(OpcUa_BrokerDataSetReaderTransportDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_BrokerDataSetReaderTransportDataType_Encode(OpcUa_BrokerDataSetReaderTransportDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_BrokerDataSetReaderTransportDataType_Decode(OpcUa_BrokerDataSetReaderTransportDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_BrokerDataSetReaderTransportDataType_Compare(const OpcUa_BrokerDataSetReaderTransportDataType* pValue1, const OpcUa_BrokerDataSetReaderTransportDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_BrokerDataSetReaderTransportDataType_Copy(const OpcUa_BrokerDataSetReaderTransportDataType* pSource, OpcUa_BrokerDataSetReaderTransportDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_BrokerDataSetReaderTransportDataType_CopyTo(const OpcUa_BrokerDataSetReaderTransportDataType* pSource, OpcUa_BrokerDataSetReaderTransportDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_BrokerDataSetReaderTransportDataType_EncodeableType;
#endif
...
#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_RolePermissionType_Compare(const OpcUa_RolePermissionType* pValue1, const OpcUa_RolePermissionType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_RolePermissionType_Copy(const OpcUa_RolePermissionType* pSource, OpcUa_RolePermissionType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_RolePermissionType_CopyTo(const OpcUa_RolePermissionType* pSource, OpcUa_RolePermissionType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */
...
#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_StructureField_Compare(const OpcUa_StructureField* pValue1, const OpcUa_StructureField* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_StructureField_Copy(const OpcUa_StructureField* pSource, OpcUa_StructureField** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_StructureField_CopyTo(const OpcUa_StructureField* pSource, OpcUa_StructureField* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */
...
#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_StructureDefinition_Compare(const OpcUa_StructureDefinition* pValue1, const OpcUa_StructureDefinition* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_StructureDefinition_Copy(const OpcUa_StructureDefinition* pSource, OpcUa_StructureDefinition** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_StructureDefinition_CopyTo(const OpcUa_StructureDefinition* pSource, OpcUa_StructureDefinition* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */
...
#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_EnumField_Compare(const OpcUa_EnumField* pValue1, const OpcUa_EnumField* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_EnumField_Copy(const OpcUa_EnumField* pSource, OpcUa_EnumField** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_EnumField_CopyTo(const OpcUa_EnumField* pSource, OpcUa_EnumField* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */
...
#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_SessionlessInvokeRequestType_Compare(const OpcUa_SessionlessInvokeRequestType* pValue1, const OpcUa_SessionlessInvokeRequestType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_SessionlessInvokeRequestType_Copy(const OpcUa_SessionlessInvokeRequestType* pSource, OpcUa_SessionlessInvokeRequestType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_SessionlessInvokeRequestType_CopyTo(const OpcUa_SessionlessInvokeRequestType* pSource, OpcUa_SessionlessInvokeRequestType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */
...
#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_SessionlessInvokeResponseType_Compare(const OpcUa_SessionlessInvokeResponseType* pValue1, const OpcUa_SessionlessInvokeResponseType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_SessionlessInvokeResponseType_Copy(const OpcUa_SessionlessInvokeResponseType* pSource, OpcUa_SessionlessInvokeResponseType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_SessionlessInvokeResponseType_CopyTo(const OpcUa_SessionlessInvokeResponseType* pSource, OpcUa_SessionlessInvokeResponseType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */
...
#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_GenericAttributeValue_Compare(const OpcUa_GenericAttributeValue* pValue1, const OpcUa_GenericAttributeValue* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_GenericAttributeValue_Copy(const OpcUa_GenericAttributeValue* pSource, OpcUa_GenericAttributeValue** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_GenericAttributeValue_CopyTo(const OpcUa_GenericAttributeValue* pSource, OpcUa_GenericAttributeValue* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */
...
#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_GenericAttributes_Compare(const OpcUa_GenericAttributes* pValue1, const OpcUa_GenericAttributes* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_GenericAttributes_Copy(const OpcUa_GenericAttributes* pSource, OpcUa_GenericAttributes** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_GenericAttributes_CopyTo(const OpcUa_GenericAttributes* pSource, OpcUa_GenericAttributes* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */
...
#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_ProgramDiagnostic2DataType_Compare(const OpcUa_ProgramDiagnostic2DataType* pValue1, const OpcUa_ProgramDiagnostic2DataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_ProgramDiagnostic2DataType_Copy(const OpcUa_ProgramDiagnostic2DataType* pSource, OpcUa_ProgramDiagnostic2DataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_ProgramDiagnostic2DataType_CopyTo(const OpcUa_ProgramDiagnostic2DataType* pSource, OpcUa_ProgramDiagnostic2DataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */
...
#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_StructureDescription_Compare(const OpcUa_StructureDescription* pValue1, const OpcUa_StructureDescription* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_StructureDescription_Copy(const OpcUa_StructureDescription* pSource, OpcUa_StructureDescription** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_StructureDescription_CopyTo(const OpcUa_StructureDescription* pSource, OpcUa_StructureDescription* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */
...
{
    OpcUa_NodeId                  EventNotifier;
    OpcUa_Int32                   NoOfSelectedFields;
    OpcUa_SimpleAttributeOperand* SelectedFields;
    OpcUa_ContentFilter           Filter;
}
OpcUa_PublishedEventsDataType;

OPCUA_EXPORT OpcUa_Void       OpcUa_PublishedEventsDataType_Initialize(OpcUa_PublishedEventsDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_PublishedEventsDataType_Clear(OpcUa_PublishedEventsDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_PublishedEventsDataType_GetSize(OpcUa_PublishedEventsDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_PublishedEventsDataType_Encode(OpcUa_PublishedEventsDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_PublishedEventsDataType_Decode(OpcUa_PublishedEventsDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_PublishedEventsDataType_Compare(const OpcUa_PublishedEventsDataType* pValue1, const OpcUa_PublishedEventsDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_PublishedEventsDataType_Copy(const OpcUa_PublishedEventsDataType* pSource, OpcUa_PublishedEventsDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_PublishedEventsDataType_CopyTo(const OpcUa_PublishedEventsDataType* pSource, OpcUa_PublishedEventsDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_PublishedEventsDataType_EncodeableType;
#endif
...
typedef struct _OpcUa_PubSubGroupDataType
{
    ...
    OpcUa_Boolean              Enabled;
    OpcUa_MessageSecurityMode  SecurityMode;
    OpcUa_String               SecurityGroupId;
    OpcUa_Int32                NoOfSecurityKeyServices;
    OpcUa_EndpointDescription* SecurityKeyServices;
    OpcUa_UInt32               MaxNetworkMessageSize;
    OpcUa_Int32                NoOfGroupProperties;
    OpcUa_KeyValuePair*        GroupProperties;
}
OpcUa_PubSubGroupDataType;

OPCUA_EXPORT OpcUa_Void       OpcUa_PubSubGroupDataType_Initialize(OpcUa_PubSubGroupDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_PubSubGroupDataType_Clear(OpcUa_PubSubGroupDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_PubSubGroupDataType_GetSize(OpcUa_PubSubGroupDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_PubSubGroupDataType_Encode(OpcUa_PubSubGroupDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_PubSubGroupDataType_Decode(OpcUa_PubSubGroupDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_PubSubGroupDataType_Compare(const OpcUa_PubSubGroupDataType* pValue1, const OpcUa_PubSubGroupDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_PubSubGroupDataType_Copy(const OpcUa_PubSubGroupDataType* pSource, OpcUa_PubSubGroupDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_PubSubGroupDataType_CopyTo(const OpcUa_PubSubGroupDataType* pSource, OpcUa_PubSubGroupDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_PubSubGroupDataType_EncodeableType;
#endif
...
typedef struct _OpcUa_WriterGroupDataType
{
    ...
    OpcUa_ExtensionObject        TransportSettings;
    OpcUa_ExtensionObject        MessageSettings;
    OpcUa_Int32                  NoOfDataSetWriters;
    OpcUa_DataSetWriterDataType* DataSetWriters;
}
OpcUa_WriterGroupDataType;

OPCUA_EXPORT OpcUa_Void       OpcUa_WriterGroupDataType_Initialize(OpcUa_WriterGroupDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_WriterGroupDataType_Clear(OpcUa_WriterGroupDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_WriterGroupDataType_GetSize(OpcUa_WriterGroupDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_WriterGroupDataType_Encode(OpcUa_WriterGroupDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_WriterGroupDataType_Decode(OpcUa_WriterGroupDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_WriterGroupDataType_Compare(const OpcUa_WriterGroupDataType* pValue1, const OpcUa_WriterGroupDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_WriterGroupDataType_Copy(const OpcUa_WriterGroupDataType* pSource, OpcUa_WriterGroupDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_WriterGroupDataType_CopyTo(const OpcUa_WriterGroupDataType* pSource, OpcUa_WriterGroupDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_WriterGroupDataType_EncodeableType;
#endif
...
{
    OpcUa_Int32                NoOfTargetVariables;
    OpcUa_FieldTargetDataType* TargetVariables;
}
OpcUa_TargetVariablesDataType;

OPCUA_EXPORT OpcUa_Void       OpcUa_TargetVariablesDataType_Initialize(OpcUa_TargetVariablesDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_TargetVariablesDataType_Clear(OpcUa_TargetVariablesDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_TargetVariablesDataType_GetSize(OpcUa_TargetVariablesDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_TargetVariablesDataType_Encode(OpcUa_TargetVariablesDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_TargetVariablesDataType_Decode(OpcUa_TargetVariablesDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_TargetVariablesDataType_Compare(const OpcUa_TargetVariablesDataType* pValue1, const OpcUa_TargetVariablesDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_TargetVariablesDataType_Copy(const OpcUa_TargetVariablesDataType* pSource, OpcUa_TargetVariablesDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_TargetVariablesDataType_CopyTo(const OpcUa_TargetVariablesDataType* pSource, OpcUa_TargetVariablesDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_TargetVariablesDataType_EncodeableType;
#endif
...
{
    OpcUa_String              ParentNodeName;
    OpcUa_Int32               NoOfRolePermissions;
    OpcUa_RolePermissionType* RolePermissions;
}
OpcUa_SubscribedDataSetMirrorDataType;

OPCUA_EXPORT OpcUa_Void       OpcUa_SubscribedDataSetMirrorDataType_Initialize(OpcUa_SubscribedDataSetMirrorDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_SubscribedDataSetMirrorDataType_Clear(OpcUa_SubscribedDataSetMirrorDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_SubscribedDataSetMirrorDataType_GetSize(OpcUa_SubscribedDataSetMirrorDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_SubscribedDataSetMirrorDataType_Encode(OpcUa_SubscribedDataSetMirrorDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_SubscribedDataSetMirrorDataType_Decode(OpcUa_SubscribedDataSetMirrorDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_SubscribedDataSetMirrorDataType_Compare(const OpcUa_SubscribedDataSetMirrorDataType* pValue1, const OpcUa_SubscribedDataSetMirrorDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_SubscribedDataSetMirrorDataType_Copy(const OpcUa_SubscribedDataSetMirrorDataType* pSource, OpcUa_SubscribedDataSetMirrorDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_SubscribedDataSetMirrorDataType_CopyTo(const OpcUa_SubscribedDataSetMirrorDataType* pSource, OpcUa_SubscribedDataSetMirrorDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_SubscribedDataSetMirrorDataType_EncodeableType;
#endif
...
#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_EnumDefinition_Compare(const OpcUa_EnumDefinition* pValue1, const OpcUa_EnumDefinition* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_EnumDefinition_Copy(const OpcUa_EnumDefinition* pSource, OpcUa_EnumDefinition** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_EnumDefinition_CopyTo(const OpcUa_EnumDefinition* pSource, OpcUa_EnumDefinition* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */
...
#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_EnumDescription_Compare(const OpcUa_EnumDescription* pValue1, const OpcUa_EnumDescription* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_EnumDescription_Copy(const OpcUa_EnumDescription* pSource, OpcUa_EnumDescription** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_EnumDescription_CopyTo(const OpcUa_EnumDescription* pSource, OpcUa_EnumDescription* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */
...
{
    OpcUa_Int32                  NoOfNamespaces;
    OpcUa_String*                Namespaces;
    ...
    OpcUa_Int32                  NoOfSimpleDataTypes;
    OpcUa_SimpleTypeDescription* SimpleDataTypes;
    OpcUa_String                 SchemaLocation;
    OpcUa_Int32                  NoOfFileHeader;
    OpcUa_KeyValuePair*          FileHeader;
    OpcUa_Variant                Body;
}
OpcUa_UABinaryFileDataType;

OPCUA_EXPORT OpcUa_Void       OpcUa_UABinaryFileDataType_Initialize(OpcUa_UABinaryFileDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_UABinaryFileDataType_Clear(OpcUa_UABinaryFileDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_UABinaryFileDataType_GetSize(OpcUa_UABinaryFileDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_UABinaryFileDataType_Encode(OpcUa_UABinaryFileDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_UABinaryFileDataType_Decode(OpcUa_UABinaryFileDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_UABinaryFileDataType_Compare(const OpcUa_UABinaryFileDataType* pValue1, const OpcUa_UABinaryFileDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_UABinaryFileDataType_Copy(const OpcUa_UABinaryFileDataType* pSource, OpcUa_UABinaryFileDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_UABinaryFileDataType_CopyTo(const OpcUa_UABinaryFileDataType* pSource, OpcUa_UABinaryFileDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_UABinaryFileDataType_EncodeableType;
#endif
...
OPCUA_EXPORT OpcUa_Void       OpcUa_DataSetMetaDataType_Initialize(OpcUa_DataSetMetaDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_DataSetMetaDataType_Clear(OpcUa_DataSetMetaDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_DataSetMetaDataType_GetSize(OpcUa_DataSetMetaDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_DataSetMetaDataType_Encode(OpcUa_DataSetMetaDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_DataSetMetaDataType_Decode(OpcUa_DataSetMetaDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_DataSetMetaDataType_Compare(const OpcUa_DataSetMetaDataType* pValue1, const OpcUa_DataSetMetaDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_DataSetMetaDataType_Copy(const OpcUa_DataSetMetaDataType* pSource, OpcUa_DataSetMetaDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_DataSetMetaDataType_CopyTo(const OpcUa_DataSetMetaDataType* pSource, OpcUa_DataSetMetaDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_DataSetMetaDataType_EncodeableType;
#endif
...
{
    OpcUa_String              Name;
    OpcUa_Int32               NoOfDataSetFolder;
    OpcUa_String*             DataSetFolder;
    OpcUa_DataSetMetaDataType DataSetMetaData;
    OpcUa_Int32               NoOfExtensionFields;
    OpcUa_KeyValuePair*       ExtensionFields;
    OpcUa_ExtensionObject     DataSetSource;
}
OpcUa_PublishedDataSetDataType;

OPCUA_EXPORT OpcUa_Void       OpcUa_PublishedDataSetDataType_Initialize(OpcUa_PublishedDataSetDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_PublishedDataSetDataType_Clear(OpcUa_PublishedDataSetDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_PublishedDataSetDataType_GetSize(OpcUa_PublishedDataSetDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_PublishedDataSetDataType_Encode(OpcUa_PublishedDataSetDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_PublishedDataSetDataType_Decode(OpcUa_PublishedDataSetDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_PublishedDataSetDataType_Compare(const OpcUa_PublishedDataSetDataType* pValue1, const OpcUa_PublishedDataSetDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_PublishedDataSetDataType_Copy(const OpcUa_PublishedDataSetDataType* pSource, OpcUa_PublishedDataSetDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_PublishedDataSetDataType_CopyTo(const OpcUa_PublishedDataSetDataType* pSource, OpcUa_PublishedDataSetDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_PublishedDataSetDataType_EncodeableType;
#endif
...
typedef struct _OpcUa_DataSetReaderDataType
{
    ...
    OpcUa_Int32                   NoOfSecurityKeyServices;
    OpcUa_EndpointDescription*    SecurityKeyServices;
    OpcUa_Int32                   NoOfDataSetReaderProperties;
    OpcUa_KeyValuePair*           DataSetReaderProperties;
    OpcUa_ExtensionObject         TransportSettings;
    OpcUa_ExtensionObject         MessageSettings;
    OpcUa_ExtensionObject         SubscribedDataSet;
}
OpcUa_DataSetReaderDataType;

OPCUA_EXPORT OpcUa_Void       OpcUa_DataSetReaderDataType_Initialize(OpcUa_DataSetReaderDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_DataSetReaderDataType_Clear(OpcUa_DataSetReaderDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_DataSetReaderDataType_GetSize(OpcUa_DataSetReaderDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_DataSetReaderDataType_Encode(OpcUa_DataSetReaderDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_DataSetReaderDataType_Decode(OpcUa_DataSetReaderDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_DataSetReaderDataType_Compare(const OpcUa_DataSetReaderDataType* pValue1, const OpcUa_DataSetReaderDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_DataSetReaderDataType_Copy(const OpcUa_DataSetReaderDataType* pSource, OpcUa_DataSetReaderDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_DataSetReaderDataType_CopyTo(const OpcUa_DataSetReaderDataType* pSource, OpcUa_DataSetReaderDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_DataSetReaderDataType_EncodeableType;
#endif
...
OPCUA_EXPORT OpcUa_Void       OpcUa_DataTypeSchemaHeader_Initialize(OpcUa_DataTypeSchemaHeader* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_DataTypeSchemaHeader_Clear(OpcUa_DataTypeSchemaHeader* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_DataTypeSchemaHeader_GetSize(OpcUa_DataTypeSchemaHeader* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_DataTypeSchemaHeader_Encode(OpcUa_DataTypeSchemaHeader* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_DataTypeSchemaHeader_Decode(OpcUa_DataTypeSchemaHeader* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_DataTypeSchemaHeader_Compare(const OpcUa_DataTypeSchemaHeader* pValue1, const OpcUa_DataTypeSchemaHeader* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_DataTypeSchemaHeader_Copy(const OpcUa_DataTypeSchemaHeader* pSource, OpcUa_DataTypeSchemaHeader** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_DataTypeSchemaHeader_CopyTo(const OpcUa_DataTypeSchemaHeader* pSource, OpcUa_DataTypeSchemaHeader* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_DataTypeSchemaHeader_EncodeableType;
#endif
...
typedef struct _OpcUa_ReaderGroupDataType
{
    ...
    OpcUa_ExtensionObject        TransportSettings;
    OpcUa_ExtensionObject        MessageSettings;
    OpcUa_Int32                  NoOfDataSetReaders;
    OpcUa_DataSetReaderDataType* DataSetReaders;
}
OpcUa_ReaderGroupDataType;

OPCUA_EXPORT OpcUa_Void       OpcUa_ReaderGroupDataType_Initialize(OpcUa_ReaderGroupDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_ReaderGroupDataType_Clear(OpcUa_ReaderGroupDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_ReaderGroupDataType_GetSize(OpcUa_ReaderGroupDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_ReaderGroupDataType_Encode(OpcUa_ReaderGroupDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_ReaderGroupDataType_Decode(OpcUa_ReaderGroupDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_ReaderGroupDataType_Compare(const OpcUa_ReaderGroupDataType* pValue1, const OpcUa_ReaderGroupDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_ReaderGroupDataType_Copy(const OpcUa_ReaderGroupDataType* pSource, OpcUa_ReaderGroupDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_ReaderGroupDataType_CopyTo(const OpcUa_ReaderGroupDataType* pSource, OpcUa_ReaderGroupDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_ReaderGroupDataType_EncodeableType;
#endif
...
typedef struct _OpcUa_PubSubConnectionDataType
{
    ...
    OpcUa_Variant              PublisherId;
    OpcUa_String               TransportProfileUri;
    OpcUa_ExtensionObject      Address;
    OpcUa_Int32                NoOfConnectionProperties;
    OpcUa_KeyValuePair*        ConnectionProperties;
    OpcUa_ExtensionObject      TransportSettings;
    OpcUa_Int32                NoOfWriterGroups;
    OpcUa_WriterGroupDataType* WriterGroups;
    OpcUa_Int32                NoOfReaderGroups;
    OpcUa_ReaderGroupDataType* ReaderGroups;
}
OpcUa_PubSubConnectionDataType;

OPCUA_EXPORT OpcUa_Void       OpcUa_PubSubConnectionDataType_Initialize(OpcUa_PubSubConnectionDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_PubSubConnectionDataType_Clear(OpcUa_PubSubConnectionDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_PubSubConnectionDataType_GetSize(OpcUa_PubSubConnectionDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_PubSubConnectionDataType_Encode(OpcUa_PubSubConnectionDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_PubSubConnectionDataType_Decode(OpcUa_PubSubConnectionDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_PubSubConnectionDataType_Compare(const OpcUa_PubSubConnectionDataType* pValue1, const OpcUa_PubSubConnectionDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_PubSubConnectionDataType_Copy(const OpcUa_PubSubConnectionDataType* pSource, OpcUa_PubSubConnectionDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_PubSubConnectionDataType_CopyTo(const OpcUa_PubSubConnectionDataType* pSource, OpcUa_PubSubConnectionDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_PubSubConnectionDataType_EncodeableType;
#endif
...
{
    OpcUa_Int32                     NoOfPublishedDataSets;
    OpcUa_PublishedDataSetDataType* PublishedDataSets;
    OpcUa_Int32                     NoOfConnections;
    OpcUa_PubSubConnectionDataType* Connections;
    OpcUa_Boolean                   Enabled;
}
OpcUa_PubSubConfigurationDataType;

OPCUA_EXPORT OpcUa_Void       OpcUa_PubSubConfigurationDataType_Initialize(OpcUa_PubSubConfigurationDataType* pValue);

OPCUA_EXPORT OpcUa_Void       OpcUa_PubSubConfigurationDataType_Clear(OpcUa_PubSubConfigurationDataType* pValue);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_PubSubConfigurationDataType_GetSize(OpcUa_PubSubConfigurationDataType* pValue, struct _OpcUa_Encoder* pEncoder, OpcUa_Int32* pSize);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_PubSubConfigurationDataType_Encode(OpcUa_PubSubConfigurationDataType* pValue, struct _OpcUa_Encoder* pEncoder);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_PubSubConfigurationDataType_Decode(OpcUa_PubSubConfigurationDataType* pValue, struct _OpcUa_Decoder* pDecoder);

#if OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED
OPCUA_EXPORT OpcUa_Int        OpcUa_PubSubConfigurationDataType_Compare(const OpcUa_PubSubConfigurationDataType* pValue1, const OpcUa_PubSubConfigurationDataType* pValue2);
#endif /* OPCUA_ENCODEABLE_OBJECT_COMPARE_SUPPORTED */

#if OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED
OPCUA_EXPORT OpcUa_StatusCode OpcUa_PubSubConfigurationDataType_Copy(const OpcUa_PubSubConfigurationDataType* pSource, OpcUa_PubSubConfigurationDataType** ppCopy);

OPCUA_EXPORT OpcUa_StatusCode OpcUa_PubSubConfigurationDataType_CopyTo(const OpcUa_PubSubConfigurationDataType* pSource, OpcUa_PubSubConfigurationDataType* pDestination);
#endif /* OPCUA_ENCODEABLE_OBJECT_COPY_SUPPORTED */

OPCUA_IMEXPORT extern struct _OpcUa_EncodeableType OpcUa_PubSubConfigurationDataType_EncodeableType;
#endif
