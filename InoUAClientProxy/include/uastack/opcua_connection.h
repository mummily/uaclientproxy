...
typedef enum _OpcUa_ConnectionEvent
{
    ...
    /** @brief Endpoint connected during reverse connect and provided it's URL. */
    , OpcUa_ConnectionEvent_ReceivedEndpointUrl
...
#if OPCUA_CONNECTION_SUPPORT_ACCEPT
/** 
  @brief Starts a passive connect (accept).
  ...
  @param pCallbackData [in] The data to return with the callback.
*/
OPCUA_EXPORT OpcUa_StatusCode OpcUa_Connection_Accept(
    OpcUa_Connection*               pConnection,
    OpcUa_String*                   sUrl,
    OpcUa_ClientCredential*         pCredentials,
    OpcUa_UInt32                    uTimeout,
...
typedef OpcUa_StatusCode (OpcUa_Connection_PfnAccept)(
    OpcUa_Connection*               pConnection,
    OpcUa_String*                   sUrl,
    OpcUa_ClientCredential*         pCredential,
    OpcUa_UInt32                    uTimeout,
...
/** 
  ...
  @param pConnection   [in] The affected connection.
  @param pCredentials  [in] The network credentials to use.
*/
OPCUA_EXPORT OpcUa_StatusCode OpcUa_Connection_SetCredentials(
    OpcUa_Connection*               pConnection,
    OpcUa_ClientCredential*         pCredentials);

typedef OpcUa_StatusCode (OpcUa_Connection_PfnSetCredentials)(
    OpcUa_Connection*               pConnection,
    OpcUa_ClientCredential*         pCredentials);
#endif /* OPCUA_CONNECTION_SUPPORT_ACCEPT */
...
#if OPCUA_CONNECTION_SUPPORT_ACCEPT
    /*! @brief Passive connect to a server. */
    OpcUa_Connection_PfnAccept* Accept;

    /*! @brief Set the credentials during reverse connect. */
    OpcUa_Connection_PfnSetCredentials* SetCredentials;
#endif /* OPCUA_CONNECTION_SUPPORT_ACCEPT */
