...
/**
 * @brief Lets the thread sleep for a certain amount of milliseconds.
 *
...
/**
 * @brief Lets the thread sleep for a certain amount of microseconds.
 * Support of this resolution is optional. System may fall back to OpcUa_Thread_Sleep
 * and only sleep for the full second portion of usecTimeout.
 *
 * @param usecTimeout [in] The time in microseconds to suspend the calling thread.
 */
OPCUA_EXPORT 
OpcUa_Void OpcUa_Thread_MicroSleep(             OpcUa_UInt64    usecTimeout);
