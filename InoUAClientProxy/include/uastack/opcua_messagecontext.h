...
typedef struct _OpcUa_MessageContext
{
    ...
    /*! @brief The maximum length for any decoded array. */
    OpcUa_UInt32 MaxArrayLength;

    /*! @brief The maximum length for any decoded String value. */
    OpcUa_UInt32 MaxStringLength;

    /*! @brief The maximum length for any decoded ByteString value. */
    OpcUa_UInt32 MaxByteStringLength;

    /*! @brief The maximum length for any decoded message. */
