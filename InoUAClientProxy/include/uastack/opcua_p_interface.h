...
typedef struct _OpcUa_P_AddressStorage OpcUa_P_AddressStorage;
...
#define OPCUA_P_ACCEPTED_SOCKET_KEEPALIVE                       OPCUA_CONFIG_YES

/** @brief Use an windows API which allows a  per socket setting of TCP keep alive parameters instead of setsockopt. */
#ifdef _MSC_VER
#ifdef _WIN32_WCE
    #define OPCUA_P_ACCEPTED_SOCKET_KEEPALIVE_OVERRIDE          OPCUA_CONFIG_NO
#else
    #define OPCUA_P_ACCEPTED_SOCKET_KEEPALIVE_OVERRIDE          OPCUA_CONFIG_YES
#endif
#else
  #define OPCUA_P_ACCEPTED_SOCKET_KEEPALIVE_OVERRIDE            OPCUA_CONFIG_NO
#endif

/* @brief The following settings are only required if OPCUA_P_ACCEPTED_SOCKET_KEEPALIVE_OVERRIDE is enabled. */
#if OPCUA_P_ACCEPTED_SOCKET_KEEPALIVE_OVERRIDE

/** @brief milliseconds with no activity until the first keep-alive packet is sent */
#define OPCUA_P_ACCEPTED_SOCKET_KEEPALIVETIME                   25000

/** @brief milliseconds between when successive keep-alive packets are sent if no ack is received */
#define OPCUA_P_ACCEPTED_SOCKET_KEEPALIVEINTERVAL               2000

#else /* OPCUA_P_ACCEPTED_SOCKET_KEEPALIVE_OVERRIDE */

/* dummy entries */
#define OPCUA_P_ACCEPTED_SOCKET_KEEPALIVETIME                   0
#define OPCUA_P_ACCEPTED_SOCKET_KEEPALIVEINTERVAL               0

#endif /* OPCUA_P_ACCEPTED_SOCKET_KEEPALIVE_OVERRIDE */
...
#define OPCUA_P_THREAD_STACKSIZE                                1048576
...
/** @brief Expect wide char host names. */
#define OPCUA_P_ALLOW_UNICODE_HOSTNAMES                         OPCUA_CONFIG_NO

/* provide optional SHA2 functionality (required for Basic256Sha256) */
#define OPCUA_P_SUPPORT_OPENSSL_SHA2                            OPCUA_CONFIG_YES

/** @brief Separator used between different fields in the configuration string. */
#ifndef OPCUA_P_CONFIGSTRING_SEPARATOR
# define OPCUA_P_CONFIGSTRING_SEPARATOR            "\\"
#endif

/* Create the configuration string for OpcUa_P_GetConfigString(). */
#define OPCUA_P_CONFIGSTRING    "TraceEnableTime:" OPCUA_TOSTRING(OPCUA_P_TRACE_ENABLE_TIME) OPCUA_P_CONFIGSTRING_SEPARATOR \
                                "TraceToFile:" OPCUA_TOSTRING(OPCUA_P_TRACE_TO_FILE) OPCUA_P_CONFIGSTRING_SEPARATOR \
                                "TraceMaxFileEntries:" OPCUA_TOSTRING(OPCUA_P_TRACE_G_MAX_FILE_ENTRIES) OPCUA_P_CONFIGSTRING_SEPARATOR \
                                "UseReuseAddr:" OPCUA_TOSTRING(OPCUA_P_SOCKET_USE_REUSEADDR) OPCUA_P_CONFIGSTRING_SEPARATOR \
                                "SocketListsStatic:" OPCUA_TOSTRING(OPCUA_P_SOCKETMANAGER_STATICARRAY) OPCUA_P_CONFIGSTRING_SEPARATOR \
                                "MaxSocketLists:" OPCUA_TOSTRING(OPCUA_P_SOCKETMANAGER_STATICMAX) OPCUA_P_CONFIGSTRING_SEPARATOR \
                                "MaxSocketsPerList:" OPCUA_TOSTRING(OPCUA_P_SOCKETMANAGER_NUMBEROFSOCKETS) OPCUA_P_CONFIGSTRING_SEPARATOR \
                                "SupportSSL:" OPCUA_TOSTRING(OPCUA_P_SOCKETMANAGER_SUPPORT_SSL) OPCUA_P_CONFIGSTRING_SEPARATOR \
                                "PreferLocalhost:" OPCUA_TOSTRING(OPCUA_P_PREFER_LOCALHOST) OPCUA_P_CONFIGSTRING_SEPARATOR \
                                "AcceptSelfSigned:" OPCUA_TOSTRING(OPCUA_P_PKI_ACCEPT_SELFSIGNED_CERTIFICATES) OPCUA_P_CONFIGSTRING_SEPARATOR \
                                "UseRandScreen:" OPCUA_TOSTRING(OPCUA_P_OPENSSL_USE_RAND_SCREEN) OPCUA_P_CONFIGSTRING_SEPARATOR \
                                "ThreadStackSize:" OPCUA_TOSTRING(OPCUA_P_THREAD_STACKSIZE) OPCUA_P_CONFIGSTRING_SEPARATOR \
                                "ServerConnectionKeepAliveEnabled:" OPCUA_TOSTRING(OPCUA_P_ACCEPTED_SOCKET_KEEPALIVE) OPCUA_P_CONFIGSTRING_SEPARATOR \
                                "ServerConnectionKeepAliveTimeOverride:" OPCUA_TOSTRING(OPCUA_P_ACCEPTED_SOCKET_KEEPALIVE_OVERRIDE) OPCUA_P_CONFIGSTRING_SEPARATOR \
                                "ServerConnectionKeepAliveTimeout:" OPCUA_TOSTRING(OPCUA_P_ACCEPTED_SOCKET_KEEPALIVETIME) OPCUA_P_CONFIGSTRING_SEPARATOR \
                                "ServerConnectionKeepAliveInterval:" OPCUA_TOSTRING(OPCUA_P_ACCEPTED_SOCKET_KEEPALIVEINTERVAL) OPCUA_P_CONFIGSTRING_SEPARATOR \
                                "SupportPolicyBasic128Rsa5:" OPCUA_TOSTRING(OPCUA_SUPPORT_SECURITYPOLICY_BASIC128RSA15) OPCUA_P_CONFIGSTRING_SEPARATOR \
                                "SupportPolicyBasic256:" OPCUA_TOSTRING(OPCUA_SUPPORT_SECURITYPOLICY_BASIC256) OPCUA_P_CONFIGSTRING_SEPARATOR \
                                "SupportPolicyBasic256Sha256:" OPCUA_TOSTRING(OPCUA_SUPPORT_SECURITYPOLICY_BASIC256SHA256) OPCUA_P_CONFIGSTRING_SEPARATOR \
                                "SupportPolicyNone:" OPCUA_TOSTRING(OPCUA_SUPPORT_SECURITYPOLICY_NONE) OPCUA_P_CONFIGSTRING_SEPARATOR \
                                "NoOfTimers:" OPCUA_TOSTRING(OPCUA_P_TIMER_NO_OF_TIMERS) OPCUA_P_CONFIGSTRING_SEPARATOR \
                                "SupportPki:" OPCUA_TOSTRING(OPCUA_SUPPORT_PKI) OPCUA_P_CONFIGSTRING_SEPARATOR \
                                "SupportSha2:" OPCUA_TOSTRING(OPCUA_P_SUPPORT_OPENSSL_SHA2)
...
#define OPCUA_SOCKET_RENEWLOOP_EVENT 0x1000 /* restarts loop to reinterpret socket list */
#define OPCUA_SOCKET_USER_EVENT      0x2000 /* user fired an event */
...
#if OPCUA_HAVE_OPENSSL
#define OPCUA_P_HASH_CREATE                         OpcUa_P_OpenSSL_Hash_Create
#else /* OPCUA_HAVE_OPENSSL */
#define OPCUA_P_HASH_CREATE                         OpcUa_P_Crypto_NoSecurity_Hash_Create
...
#define OPCUA_P_THREAD_MICROSLEEP                   OpcUa_P_Thread_MicroSleep
...
struct S_OpcUa_Port_CallTable
{
    ...
    /** @brief Let the calling thread sleep for usecTimeout microseconds.
     *  @ingroup opcua_platformlayer_interface
     */
    OpcUa_Void          (OPCUA_DLLCALL* ThreadMicroSleep)         ( OpcUa_UInt64                usecTimeout);
    ...
    /** @brief Create the hash value of the given data.
     *  @ingroup opcua_platformlayer_interface
     */
    OpcUa_StatusCode    (OPCUA_DLLCALL* HashCreate)               ( void );
