...
#define PROD_MINOR  6
#define PROD_PATCH  2
#define PROD_BUILD  402
#define PROD_SUFFIX " / f469032e2672888416922436fc3290e24941cda2"
...
// define to avoid implicit-fallthrough warning
#if (defined(__clang__) && __cplusplus >= 201103L) || __cplusplus >= 201703L
#  define UA_IMPLICIT_FALLTHROUGH [[fallthrough]];
#else
#  define UA_IMPLICIT_FALLTHROUGH
#endif
...
UABASE_EXPORT size_t UaBase_strlcat(char *dst, const char *src, size_t len);
UABASE_EXPORT size_t UaBase_strlcpy(char *dst, const char *src, size_t len);
...
#define UASDK_WITH_COM_UTILITIES OPCUA_CONFIG_ON
#endif
