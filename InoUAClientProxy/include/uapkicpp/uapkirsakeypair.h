...
public:
    ...
    inline bool isValid() const { return ( m_pKey != 0 && m_pKey->pkey.rsa != 0 && EVP_PKEY_missing_parameters ( m_pKey ) == 0); }
#else
    inline bool isValid() const { return ( m_pKey != 0 && EVP_PKEY_get0_RSA(m_pKey) != 0 && EVP_PKEY_missing_parameters ( m_pKey ) == 0); }
#endif
