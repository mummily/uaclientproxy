...
class SERVER_CORE_EXPORT RoleTypeOperations;
...
public:
     ...
     *  @return The DefaultPermission or NULL if not configured
    */
    ...
    *  @param roleName              The name for the new Role to add.
    *  @param ppRoleTypeOperations  A pointer to the RoleOperation interface created by the Nodemanager.
    *  @return                      Error code
    */
    ...
    *  @param pRoleTypeOperations   A pointer to the RoleOperation interface.
    *  @return                      Error code
    */
...
public:
    ...
    *  @param namespaceIndex    Namespace index of the namespace to get the default NodeAccessInfo.
    *  @return                  NodeAccessInfo or NULL if not available
    */
    virtual NodeAccessInfo* getDefaultPermissions(OpcUa_UInt16 namespaceIndex) const = 0;
};
