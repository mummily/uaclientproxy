...
class SERVER_CORE_EXPORT NodeManagerUaNode:
    ...
    ,public OpcUa::AddressSpaceFileCallback
...
#if SUPPORT_Method_Server_Facet
    //- Interface AddressSpaceFileCallback -----------------------------------------------
...
protected:
    ...
    /* Utility method to create a RoleTypeOperation and register the new role */
    UaStatus addRole(const UaString& roleName, RoleTypeOperations** ppRoleTypeOperations);
    ...
    NodeAccessInfo* m_pDefaultAccessPermissions;
    OpcUa::NamespaceMetadataType* m_pNamespaceMetaData;
    UaString m_sNamespaceMetaDataNamespaceFile;
    bool m_makeDefaultPermissionPropertyVisible;
};
