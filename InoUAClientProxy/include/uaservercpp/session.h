...
public:
    ...
    //  Close the session
    virtual UaStatus close(OpcUa_Boolean deleteSubscriptions, OpcUa_Boolean calledFromShutdown = OpcUa_False);
    ...
    virtual OpcUa_Boolean isSessionLess() const;
    ...
    OpcUa_Boolean getApplicationUriMismatch() const;
    void setApplicationUriMismatch(OpcUa_Boolean bMismatch) const;
    ...
    void setUserTokenType(OpcUa_UserTokenType userTokenType);
    OpcUa_UserTokenType getUserTokenType() const;
    ...
    virtual void setSecureChannelMutex(UaMutexRefCounted*){}
    virtual void userSecurityContextChanged() {}
