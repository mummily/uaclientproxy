...
public:
    ...
    */
    ...
    // Get and Set Default Permissions
    virtual void setIODefaultPermissions(NodeAccessInfo* pDefaultPermissions);
    virtual NodeAccessInfo* getIODefaultPermissions(OpcUa_UInt16 namespaceIndex) const;
