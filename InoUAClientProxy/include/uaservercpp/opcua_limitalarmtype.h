 ...
 *  ------------------|----------|----------------|----------------|-------------------------------------------------------------------------------------------------------------------------------------------
 *  BaseHighHighLimit | Double   | PropertyType   | Optional       | \ref LimitAlarmTypeBase::getBaseHighHighLimit "getBaseHighHighLimit", \ref LimitAlarmTypeBase::setBaseHighHighLimit "setBaseHighHighLimit"
 *  BaseHighLimit     | Double   | PropertyType   | Optional       | \ref LimitAlarmTypeBase::getBaseHighLimit "getBaseHighLimit", \ref LimitAlarmTypeBase::setBaseHighLimit "setBaseHighLimit"
 *  BaseLowLimit      | Double   | PropertyType   | Optional       | \ref LimitAlarmTypeBase::getBaseLowLimit "getBaseLowLimit", \ref LimitAlarmTypeBase::setBaseLowLimit "setBaseLowLimit"
 *  BaseLowLowLimit   | Double   | PropertyType   | Optional       | \ref LimitAlarmTypeBase::getBaseLowLowLimit "getBaseLowLowLimit", \ref LimitAlarmTypeBase::setBaseLowLowLimit "setBaseLowLowLimit"
