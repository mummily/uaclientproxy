 ...
 *  ConditionSubClassId   | NodeId        | PropertyType          | Optional       | \ref ConditionTypeBase::getConditionSubClassId "getConditionSubClassId", \ref ConditionTypeBase::setConditionSubClassId "setConditionSubClassId"
 *  ConditionSubClassName | LocalizedText | PropertyType          | Optional       | \ref ConditionTypeBase::getConditionSubClassName "getConditionSubClassName", \ref ConditionTypeBase::setConditionSubClassName "setConditionSubClassName"
