 ...
 *  Browse Name      | DataType | TypeDefinition | Modelling Rule | See Also
 *  -----------------|----------|----------------|----------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------
 *  BaseSetpointNode | NodeId   | PropertyType   | Optional       | \ref ExclusiveDeviationAlarmType::getBaseSetpointNode "getBaseSetpointNode", \ref ExclusiveDeviationAlarmType::setBaseSetpointNode "setBaseSetpointNode"
 *  SetpointNode     | NodeId   | PropertyType   | Mandatory      | \ref ExclusiveDeviationAlarmType::getSetpointNode "getSetpointNode", \ref ExclusiveDeviationAlarmType::setSetpointNode "setSetpointNode"
 *
 *  A special deviation alarm utilized with multiple mutually exclusive limits.
 *
 *  A deviation Alarm is commonly used to report an excess deviation between a
