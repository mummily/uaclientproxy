 ...
 *  ---------------------------|--------------------|----------------|----------------|-----------------------------------------------------------------------
 *  DefaultAccessRestrictions  | UInt16             | PropertyType   | Optional       | \ref getDefaultAccessRestrictions, \ref setDefaultAccessRestrictions
 *  DefaultRolePermissions     | RolePermissionType | PropertyType   | Optional       | \ref getDefaultRolePermissions, \ref setDefaultRolePermissions
 *  DefaultUserRolePermissions | RolePermissionType | PropertyType   | Optional       | \ref getDefaultUserRolePermissions, \ref setDefaultUserRolePermissions
...
public:
    ...
    virtual OpcUa::PropertyType* getDefaultAccessRestrictionsNode();
    virtual const OpcUa::PropertyType* getDefaultAccessRestrictionsNode() const;
    virtual OpcUa::PropertyType* getDefaultRolePermissionsNode();
    virtual const OpcUa::PropertyType* getDefaultRolePermissionsNode() const;
    virtual OpcUa::PropertyType* getDefaultUserRolePermissionsNode();
    virtual const OpcUa::PropertyType* getDefaultUserRolePermissionsNode() const;
...
protected:
    ...
    // Variable nodes
    // Variable DefaultAccessRestrictions
    static OpcUa::PropertyType*  s_pDefaultAccessRestrictions;
    OpcUa::PropertyType*  m_pDefaultAccessRestrictions;
    // Variable DefaultRolePermissions
    static OpcUa::PropertyType*  s_pDefaultRolePermissions;
    OpcUa::PropertyType*  m_pDefaultRolePermissions;
    // Variable DefaultUserRolePermissions
    static OpcUa::PropertyType*  s_pDefaultUserRolePermissions;
    OpcUa::PropertyType*  m_pDefaultUserRolePermissions;
