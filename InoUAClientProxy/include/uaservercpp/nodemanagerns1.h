...
#if SUPPORT_TRACE_EVENTS
class TraceEventHook;
#endif // SUPPORT_TRACE_EVENTS
...
#if SUPPORT_TRACE_EVENTS
    static void createPreTraceHook();
    static void clearPreTraceHook();
private:
    static TraceEventHook* s_pTraceHook;
#endif // SUPPORT_TRACE_EVENTS
};
