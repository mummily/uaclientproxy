 ...
 *  of the event fields and to send the event to interested clients through EventManagerBase::fireEvent().
 *
 *  **Event Fields of the AuditSecurityEventType:**
 *
 *  Browse Name  | DataType   | TypeDefinition | Modelling Rule | See Also
 *  -------------|------------|----------------|----------------|-------------------------------------------
 *  StatusCodeId | StatusCode | PropertyType   | Optional       | \ref getStatusCodeId, \ref setStatusCodeId
...
public:
    ...
    virtual void getFieldData(OpcUa_UInt32 index, Session* pSession, OpcUa_Variant& data);
    // StatusCodeId
    void setStatusCodeId(OpcUa_StatusCode StatusCodeId);
    void setStatusCodeIdStatus(OpcUa_StatusCode status);
    OpcUa_StatusCode getStatusCodeId();
    virtual void getStatusCodeIdValue(Session* pSession, OpcUa_Variant& value);
 ...
 *  ConditionEventId | ByteString    | PropertyType   | Mandatory      | \ref getConditionEventId, \ref setConditionEventId
...
public:
    ...
    // ConditionEventId
    void setConditionEventId(UaByteString& ConditionEventId);
    void setConditionEventIdStatus(OpcUa_StatusCode status);
    UaByteString getConditionEventId();
    virtual void getConditionEventIdValue(Session* pSession, OpcUa_Variant& value);
...
/** Event data class for the OPC UA event type AuditConditionOutOfServiceEventType.
 *
 *  This class provides the functionality necessary to create an event of type AuditConditionOutOfServiceEventType, to set the values
 *  of the event fields and to send the event to interested clients through EventManagerBase::fireEvent().

 */
class SERVER_CORE_EXPORT AuditConditionOutOfServiceEventTypeData:
    public OpcUa::AuditConditionEventTypeData
{
    UA_DISABLE_COPY(AuditConditionOutOfServiceEventTypeData);
public:
    AuditConditionOutOfServiceEventTypeData();
    virtual ~AuditConditionOutOfServiceEventTypeData();
...
private:
    static bool                                 s_typeNodesCreated;
    static std::map<OpcUa_UInt32, OpcUa_UInt32> s_AuditConditionOutOfServiceEventTypeDataFields;
    UaObjectPointerArray<UaVariant>             m_FieldValues;
};

/** Event data class for the OPC UA event type AuditConditionResetEventType.
 *
 *  This class provides the functionality necessary to create an event of type AuditConditionResetEventType, to set the values
 *  of the event fields and to send the event to interested clients through EventManagerBase::fireEvent().

 */
class SERVER_CORE_EXPORT AuditConditionResetEventTypeData:
    public OpcUa::AuditConditionEventTypeData
{
    UA_DISABLE_COPY(AuditConditionResetEventTypeData);
public:
    AuditConditionResetEventTypeData();
    virtual ~AuditConditionResetEventTypeData();
...
private:
    static bool                                 s_typeNodesCreated;
    static std::map<OpcUa_UInt32, OpcUa_UInt32> s_AuditConditionResetEventTypeDataFields;
    UaObjectPointerArray<UaVariant>             m_FieldValues;
};
...
/** Event data class for the OPC UA event type AuditConditionSilenceEventType.
 *
 *  This class provides the functionality necessary to create an event of type AuditConditionSilenceEventType, to set the values
 *  of the event fields and to send the event to interested clients through EventManagerBase::fireEvent().

 */
class SERVER_CORE_EXPORT AuditConditionSilenceEventTypeData:
    public OpcUa::AuditConditionEventTypeData
{
    UA_DISABLE_COPY(AuditConditionSilenceEventTypeData);
public:
    AuditConditionSilenceEventTypeData();
    virtual ~AuditConditionSilenceEventTypeData();
...
private:
    static bool                                 s_typeNodesCreated;
    static std::map<OpcUa_UInt32, OpcUa_UInt32> s_AuditConditionSilenceEventTypeDataFields;
    UaObjectPointerArray<UaVariant>             m_FieldValues;
};

/** Event data class for the OPC UA event type AuditConditionSuppressEventType.
 *
 *  This class provides the functionality necessary to create an event of type AuditConditionSuppressEventType, to set the values
 *  of the event fields and to send the event to interested clients through EventManagerBase::fireEvent().

 */
class SERVER_CORE_EXPORT AuditConditionSuppressEventTypeData:
    public OpcUa::AuditConditionEventTypeData
{
    UA_DISABLE_COPY(AuditConditionSuppressEventTypeData);
public:
    AuditConditionSuppressEventTypeData();
    virtual ~AuditConditionSuppressEventTypeData();
...
private:
    static bool                                 s_typeNodesCreated;
    static std::map<OpcUa_UInt32, OpcUa_UInt32> s_AuditConditionSuppressEventTypeDataFields;
    UaObjectPointerArray<UaVariant>             m_FieldValues;
};
...
/** Event data class for the OPC UA event type KeyCredentialAuditEventType.
 *
 *  This class provides the functionality necessary to create an event of type KeyCredentialAuditEventType, to set the values
 *  of the event fields and to send the event to interested clients through EventManagerBase::fireEvent().
 *
 *  **Event Fields of the KeyCredentialAuditEventType:**
 *
 *  Browse Name | DataType | TypeDefinition | Modelling Rule | See Also
 *  ------------|----------|----------------|----------------|-----------------------------------------
 *  ResourceUri | String   | PropertyType   | Mandatory      | \ref getResourceUri, \ref setResourceUri

 */
class SERVER_CORE_EXPORT KeyCredentialAuditEventTypeData:
    public OpcUa::AuditUpdateMethodEventTypeData
{
    UA_DISABLE_COPY(KeyCredentialAuditEventTypeData);
public:
    KeyCredentialAuditEventTypeData();
    virtual ~KeyCredentialAuditEventTypeData();
    ...
    void setResourceUriStatus(OpcUa_StatusCode status);
    UaString getResourceUri();
    virtual void getResourceUriValue(Session* pSession, OpcUa_Variant& value);

private:
    static bool                                 s_typeNodesCreated;
    static std::map<OpcUa_UInt32, OpcUa_UInt32> s_KeyCredentialAuditEventTypeDataFields;
    UaObjectPointerArray<UaVariant>             m_FieldValues;
};

/** Event data class for the OPC UA event type KeyCredentialDeletedAuditEventType.
 *
 *  This class provides the functionality necessary to create an event of type KeyCredentialDeletedAuditEventType, to set the values
 *  of the event fields and to send the event to interested clients through EventManagerBase::fireEvent().

 */
class SERVER_CORE_EXPORT KeyCredentialDeletedAuditEventTypeData:
    public OpcUa::KeyCredentialAuditEventTypeData
{
    UA_DISABLE_COPY(KeyCredentialDeletedAuditEventTypeData);
public:
    KeyCredentialDeletedAuditEventTypeData();
    virtual ~KeyCredentialDeletedAuditEventTypeData();
...
private:
    static bool                                 s_typeNodesCreated;
    static std::map<OpcUa_UInt32, OpcUa_UInt32> s_KeyCredentialDeletedAuditEventTypeDataFields;
    UaObjectPointerArray<UaVariant>             m_FieldValues;
};

/** Event data class for the OPC UA event type KeyCredentialUpdatedAuditEventType.
 *
 *  This class provides the functionality necessary to create an event of type KeyCredentialUpdatedAuditEventType, to set the values
 *  of the event fields and to send the event to interested clients through EventManagerBase::fireEvent().

 */
class SERVER_CORE_EXPORT KeyCredentialUpdatedAuditEventTypeData:
    public OpcUa::KeyCredentialAuditEventTypeData
{
    UA_DISABLE_COPY(KeyCredentialUpdatedAuditEventTypeData);
public:
    KeyCredentialUpdatedAuditEventTypeData();
    virtual ~KeyCredentialUpdatedAuditEventTypeData();
...
private:
    static bool                                 s_typeNodesCreated;
    static std::map<OpcUa_UInt32, OpcUa_UInt32> s_KeyCredentialUpdatedAuditEventTypeDataFields;
    UaObjectPointerArray<UaVariant>             m_FieldValues;
};

/** Event data class for the OPC UA event type RoleMappingRuleChangedAuditEventType.
 *
 *  This class provides the functionality necessary to create an event of type RoleMappingRuleChangedAuditEventType, to set the values
 *  of the event fields and to send the event to interested clients through EventManagerBase::fireEvent().

 */
class SERVER_CORE_EXPORT RoleMappingRuleChangedAuditEventTypeData:
    public OpcUa::AuditUpdateMethodEventTypeData
{
    UA_DISABLE_COPY(RoleMappingRuleChangedAuditEventTypeData);
public:
    RoleMappingRuleChangedAuditEventTypeData();
    virtual ~RoleMappingRuleChangedAuditEventTypeData();
...
private:
    static bool                                 s_typeNodesCreated;
    static std::map<OpcUa_UInt32, OpcUa_UInt32> s_RoleMappingRuleChangedAuditEventTypeDataFields;
    UaObjectPointerArray<UaVariant>             m_FieldValues;
};
