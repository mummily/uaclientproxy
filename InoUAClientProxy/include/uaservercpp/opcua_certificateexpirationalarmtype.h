 ...
 *  ExpirationLimit | Duration   | PropertyType   | Optional       | \ref getExpirationLimit, \ref setExpirationLimit
...
public:
    ...
    // ExpirationLimit
    void setExpirationLimit(OpcUa_Double ExpirationLimit);
    void setExpirationLimitStatus(OpcUa_StatusCode status);
    OpcUa_Double getExpirationLimit();
    virtual void getExpirationLimitValue(Session* pSession, OpcUa_Variant& value);
...
public:
    ...
    // ExpirationLimit
    virtual void setExpirationLimit(OpcUa_Double ExpirationLimit);
    virtual OpcUa_Double getExpirationLimit() const;
    virtual void setExpirationLimitStatus(OpcUa_StatusCode status);
    virtual void getExpirationLimitValue(Session* pSession, UaVariant& value);

    virtual OpcUa::PropertyType* getCertificateNode();
    virtual const OpcUa::PropertyType* getCertificateNode() const;
    virtual OpcUa::PropertyType* getCertificateTypeNode();
    virtual const OpcUa::PropertyType* getCertificateTypeNode() const;
    virtual OpcUa::PropertyType* getExpirationDateNode();
    virtual const OpcUa::PropertyType* getExpirationDateNode() const;
    virtual OpcUa::PropertyType* getExpirationLimitNode();
    virtual const OpcUa::PropertyType* getExpirationLimitNode() const;
...
protected:
    ...
    // Variable ExpirationLimit
    static OpcUa::PropertyType*  s_pExpirationLimit;
    OpcUa::PropertyType*  m_pExpirationLimit;
