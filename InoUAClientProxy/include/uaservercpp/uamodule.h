...
/** @ingroup CppUaModule
 *  @brief Interface class for the OPC UA server module.
...
public:
    ...
    int initialize(ServerConfig* pServerConfig, UaServer* pUaServer = 0, UaDurableSubscriptionCallback* pCallback = 0);
