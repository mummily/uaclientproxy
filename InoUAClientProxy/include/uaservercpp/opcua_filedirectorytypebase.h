...
protected:
    // Object nodes
    // Object FileDirectoryName_Placeholder
    static OpcUa::FileDirectoryType*  s_pFileDirectoryName_Placeholder;
    // Object FileName_Placeholder
    static OpcUa::FileType*  s_pFileName_Placeholder;
